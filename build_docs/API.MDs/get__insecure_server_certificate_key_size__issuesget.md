Get "insecure\_server\_certificate\_key\_size" issues
=====================================================

get https://api.securityscorecard.io/companies/{scorecard\_identifier}/issues/insecure\_server\_certificate\_key\_size

Get "insecure\_server\_certificate\_key\_size" issues in a scorecard
...
A page in a list of InsecureServerCertificateKeySizes
...
[Log in to use your API keys](/login?redirect_uri=/reference/get_companies-scorecard-identifier-issues-insecure-server-certificate-key-size)
...
2
     ...
     \--url https://api.securityscorecard.io/companies/scorecard\_identifier/issues/insecure\_server\_certificate\_key\_size \\
