Get "service\_ldap\_anonymous" issues in a scorecard
====================================================

get https://api.securityscorecard.io/companies/{scorecard\_identifier}/issues/service\_ldap\_anonymous
...
A page in a list of ServiceLdapAnonymous
...
[Log in to use your API keys](/login?redirect_uri=/reference/get_companies-scorecard-identifier-issues-service-ldap-anonymous-1)
...
2
     ...
     \--url https://api.securityscorecard.io/companies/scorecard\_identifier/issues/service\_ldap\_anonymous \\
