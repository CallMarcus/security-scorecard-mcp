Get "tlscert\_excessive\_expiration" issues in a sco
====================================================

get https://api.securityscorecard.io/companies/{scorecard\_identifier}/issues/tlscert\_excessive\_expiration

Get "tlscert\_excessive\_expiration" issues in a scorecard
...
A page in a list of TlscertExcessiveExpirations
...
[Log in to use your API keys](/login?redirect_uri=/reference/get_companies-scorecard-identifier-issues-tlscert-excessive-expiration-1)
...
2
     ...
     \--url https://api.securityscorecard.io/companies/scorecard\_identifier/issues/tlscert\_excessive\_expiration \\
