Get "alleged\_breach\_incident" issues in a scorecar
====================================================

get https://api.securityscorecard.io/companies/{scorecard\_identifier}/issues/alleged\_breach\_incident

Get "alleged\_breach\_incident" issues in a scorecard
...
A page in a list of AllegedBreachIncidents
...
[Log in to use your API keys](/login?redirect_uri=/reference/get_companies-scorecard-identifier-issues-alleged-breach-incident)
...
2
     ...
     \--url https://api.securityscorecard.io/companies/scorecard\_identifier/issues/alleged\_breach\_incident \\
