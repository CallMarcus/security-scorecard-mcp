...
get https://api.securityscorecard.io/companies/{scorecard\_identifier}/expanded-risk
...
[Log in to use your API keys](/login?redirect_uri=/reference/get_companies-scorecard-identifier-expanded-risk)
...
2
     ...
     \--url https://api.securityscorecard.io/companies/scorecard\_identifier/expanded-risk \\
