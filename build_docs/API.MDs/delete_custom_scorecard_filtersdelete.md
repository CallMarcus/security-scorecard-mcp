...
delete https://api.securityscorecard.io/custom-scorecards/{id}/filters
...
id of custom scorecard to delete filters
...
[Log in to use your API keys](/login?redirect_uri=/reference/delete_custom-scorecards-id-filters)
...
2
     ...
     \--url https://api.securityscorecard.io/custom-scorecards/id/filters \\
