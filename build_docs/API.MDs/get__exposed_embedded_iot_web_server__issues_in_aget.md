Get "exposed\_embedded\_iot\_web\_server" issues in a
=====================================================

get https://api.securityscorecard.io/companies/{scorecard\_identifier}/issues/exposed\_embedded\_iot\_web\_server

Get "exposed\_embedded\_iot\_web\_server" issues in a scorecard
...
A page in a list of ExposedEmbeddedIotWebServers
...
[Log in to use your API keys](/login?redirect_uri=/reference/get_companies-scorecard-identifier-issues-exposed-embedded-iot-web-server)
...
2
     ...
     \--url https://api.securityscorecard.io/companies/scorecard\_identifier/issues/exposed\_embedded\_iot\_web\_server \\
