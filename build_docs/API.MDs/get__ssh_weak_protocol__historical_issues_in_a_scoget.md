Get "ssh\_weak\_protocol" historical issues in a sco
====================================================

get https://api.securityscorecard.io/companies/{scorecard\_identifier}/history/events/{effective\_date}/issues/ssh\_weak\_protocol/

Get "ssh\_weak\_protocol" historical issues in a scorecard
...
A page in a list of HistoricalSshWeakProtocols
...
[Log in to use your API keys](/login?redirect_uri=/reference/get_companies-scorecard-identifier-history-events-effective-date-issues-ssh-weak-protocol-1)
...
2
     ...
     \--url https://api.securityscorecard.io/companies/scorecard\_identifier/history/events/effective\_date/issues/ssh\_weak\_protocol/ \\
