Get "webapp\_vulnerable\_to\_spring4shell" issues in
====================================================

get https://api.securityscorecard.io/companies/{scorecard\_identifier}/issues/webapp\_vulnerable\_to\_spring4shell

Get "webapp\_vulnerable\_to\_spring4shell" issues in a scorecard
...
[Log in to use your API keys](/login?redirect_uri=/reference/get_companies-scorecard-identifier-issues-webapp-vulnerable-to-spring4shell-1)
...
2
     ...
     \--url https://api.securityscorecard.io/companies/scorecard\_identifier/issues/webapp\_vulnerable\_to\_spring4shell \\
