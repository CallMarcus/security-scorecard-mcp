Get "payment\_provider" historical issues in a scor
===================================================

get https://api.securityscorecard.io/companies/{scorecard\_identifier}/history/events/{effective\_date}/issues/payment\_provider/

Get "payment\_provider" historical issues in a scorecard
...
A page in a list of HistoricalPaymentProviders
...
[Log in to use your API keys](/login?redirect_uri=/reference/get_companies-scorecard-identifier-history-events-effective-date-issues-payment-provider-1)
...
2
     ...
     \--url https://api.securityscorecard.io/companies/scorecard\_identifier/history/events/effective\_date/issues/payment\_provider/ \\
