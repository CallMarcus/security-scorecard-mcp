Get "malicious\_scan\_detected" issues in a scorecar
====================================================

get https://api.securityscorecard.io/companies/{scorecard\_identifier}/issues/malicious\_scan\_detected

Get "malicious\_scan\_detected" issues in a scorecard
...
A page in a list of MaliciousScanDetecteds
...
[Log in to use your API keys](/login?redirect_uri=/reference/get_companies-scorecard-identifier-issues-malicious-scan-detected)
...
2
     ...
     \--url https://api.securityscorecard.io/companies/scorecard\_identifier/issues/malicious\_scan\_detected \\
