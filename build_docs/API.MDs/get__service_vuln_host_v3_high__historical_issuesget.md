Get "service\_vuln\_host\_v3\_high" historical issues
=====================================================

get https://api.securityscorecard.io/companies/{scorecard\_identifier}/history/events/{effective\_date}/issues/service\_vuln\_host\_v3\_high/

Get "service\_vuln\_host\_v3\_high" historical issues in a scorecard
...
A page in a list of HistoricalServiceVulnHostV3Highs
...
[Log in to use your API keys](/login?redirect_uri=/reference/get_companies-scorecard-identifier-history-events-effective-date-issues-service-vuln-host-v3-high)
...
2
     ...
     \--url https://api.securityscorecard.io/companies/scorecard\_identifier/history/events/effective\_date/issues/service\_vuln\_host\_v3\_high/ \\
