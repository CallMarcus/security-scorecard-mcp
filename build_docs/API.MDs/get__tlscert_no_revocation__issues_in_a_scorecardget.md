Get "tlscert\_no\_revocation" issues in a scorecard
===================================================

get https://api.securityscorecard.io/companies/{scorecard\_identifier}/issues/tlscert\_no\_revocation
...
A page in a list of TlscertNoRevocations
...
[Log in to use your API keys](/login?redirect_uri=/reference/get_companies-scorecard-identifier-issues-tlscert-no-revocation-1)
...
2
     ...
     \--url https://api.securityscorecard.io/companies/scorecard\_identifier/issues/tlscert\_no\_revocation \\
