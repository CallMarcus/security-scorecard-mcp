Get "potentially\_vulnerable\_cve\_2023\_3519" issues
=====================================================

get https://api.securityscorecard.io/companies/{scorecard\_identifier}/issues/potentially\_vulnerable\_cve\_2023\_3519

Get "potentially\_vulnerable\_cve\_2023\_3519" issues in a scorecard
...
A page in a list of PotentiallyVulnerableCve20233519s
...
[Log in to use your API keys](/login?redirect_uri=/reference/get_companies-scorecard-identifier-issues-potentially-vulnerable-cve-2023-3519)
...
2
     ...
     \--url https://api.securityscorecard.io/companies/scorecard\_identifier/issues/potentially\_vulnerable\_cve\_2023\_3519 \\
