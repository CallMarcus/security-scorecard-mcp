Get "tlscert\_weak\_signature" issues in a scorecard
====================================================

get https://api.securityscorecard.io/companies/{scorecard\_identifier}/issues/tlscert\_weak\_signature
...
A page in a list of TlscertWeakSignatures
...
[Log in to use your API keys](/login?redirect_uri=/reference/get_companies-scorecard-identifier-issues-tlscert-weak-signature-1)
...
2
     ...
     \--url https://api.securityscorecard.io/companies/scorecard\_identifier/issues/tlscert\_weak\_signature \\
