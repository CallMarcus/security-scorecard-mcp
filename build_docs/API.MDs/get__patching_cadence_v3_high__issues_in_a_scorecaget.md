Get "patching\_cadence\_v3\_high" issues in a scoreca
=====================================================

get https://api.securityscorecard.io/companies/{scorecard\_identifier}/issues/patching\_cadence\_v3\_high

Get "patching\_cadence\_v3\_high" issues in a scorecard
...
[Log in to use your API keys](/login?redirect_uri=/reference/get_companies-scorecard-identifier-issues-patching-cadence-v3-high)
...
2
     ...
     \--url https://api.securityscorecard.io/companies/scorecard\_identifier/issues/patching\_cadence\_v3\_high \\
