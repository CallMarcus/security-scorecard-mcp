Get "websocket\_receives\_data" issues in a scorecar
====================================================

get https://api.securityscorecard.io/companies/{scorecard\_identifier}/issues/websocket\_receives\_data

Get "websocket\_receives\_data" issues in a scorecard
...
A page in a list of WebsocketReceivesData
...
[Log in to use your API keys](/login?redirect_uri=/reference/get_companies-scorecard-identifier-issues-websocket-receives-data-1)
...
2
     ...
     \--url https://api.securityscorecard.io/companies/scorecard\_identifier/issues/websocket\_receives\_data \\
