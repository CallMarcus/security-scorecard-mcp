Get "cookie\_missing\_http\_only" issues in a scoreca
=====================================================

get https://api.securityscorecard.io/companies/{scorecard\_identifier}/issues/cookie\_missing\_http\_only

Get "cookie\_missing\_http\_only" issues in a scorecard
...
[Log in to use your API keys](/login?redirect_uri=/reference/get_companies-scorecard-identifier-issues-cookie-missing-http-only)
...
2
     ...
     \--url https://api.securityscorecard.io/companies/scorecard\_identifier/issues/cookie\_missing\_http\_only \\
