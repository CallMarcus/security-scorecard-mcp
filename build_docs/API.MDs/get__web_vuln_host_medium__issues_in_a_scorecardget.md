Get "web\_vuln\_host\_medium" issues in a scorecard
===================================================

get https://api.securityscorecard.io/companies/{scorecard\_identifier}/issues/web\_vuln\_host\_medium
...
A page in a list of WebVulnHostMediums
...
[Log in to use your API keys](/login?redirect_uri=/reference/get_companies-scorecard-identifier-issues-web-vuln-host-medium-1)
...
2
     ...
     \--url https://api.securityscorecard.io/companies/scorecard\_identifier/issues/web\_vuln\_host\_medium \\
