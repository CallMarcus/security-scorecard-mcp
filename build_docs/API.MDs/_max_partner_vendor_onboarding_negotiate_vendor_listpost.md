...
post https://api.securityscorecard.io/max/partner/vendor-onboarding/negotiate-vendor-list
...
[Log in to use your API keys](/login?redirect_uri=/reference/post_max-partner-vendor-onboarding-negotiate-vendor-list)
