Get "service\_postgresql" historical issues in a sc
===================================================

get https://api.securityscorecard.io/companies/{scorecard\_identifier}/history/events/{effective\_date}/issues/service\_postgresql/

Get "service\_postgresql" historical issues in a scorecard
...
A page in a list of HistoricalServicePostgresqls
...
[Log in to use your API keys](/login?redirect_uri=/reference/get_companies-scorecard-identifier-history-events-effective-date-issues-service-postgresql-1)
...
2
     ...
     \--url https://api.securityscorecard.io/companies/scorecard\_identifier/history/events/effective\_date/issues/service\_postgresql/ \\
