Get "attempted\_information\_leak" issues in a score
====================================================

get https://api.securityscorecard.io/companies/{scorecard\_identifier}/issues/attempted\_information\_leak

Get "attempted\_information\_leak" issues in a scorecard
...
A page in a list of AttemptedInformationLeaks
...
[Log in to use your API keys](/login?redirect_uri=/reference/get_companies-scorecard-identifier-issues-attempted-information-leak)
...
2
     ...
     \--url https://api.securityscorecard.io/companies/scorecard\_identifier/issues/attempted\_information\_leak \\
