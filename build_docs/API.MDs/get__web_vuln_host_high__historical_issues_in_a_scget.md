Get "web\_vuln\_host\_high" historical issues in a sc
=====================================================

get https://api.securityscorecard.io/companies/{scorecard\_identifier}/history/events/{effective\_date}/issues/web\_vuln\_host\_high/

Get "web\_vuln\_host\_high" historical issues in a scorecard
...
A page in a list of HistoricalWebVulnHostHighs
...
[Log in to use your API keys](/login?redirect_uri=/reference/get_companies-scorecard-identifier-history-events-effective-date-issues-web-vuln-host-high-1)
...
2
     ...
     \--url https://api.securityscorecard.io/companies/scorecard\_identifier/history/events/effective\_date/issues/web\_vuln\_host\_high/ \\
