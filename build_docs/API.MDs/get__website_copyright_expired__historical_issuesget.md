Get "website\_copyright\_expired" historical issues
===================================================

get https://api.securityscorecard.io/companies/{scorecard\_identifier}/history/events/{effective\_date}/issues/website\_copyright\_expired/

Get "website\_copyright\_expired" historical issues in a scorecard
...
A page in a list of HistoricalWebsiteCopyrightExpireds
...
[Log in to use your API keys](/login?redirect_uri=/reference/get_companies-scorecard-identifier-history-events-effective-date-issues-website-copyright-expired-1)
...
2
     ...
     \--url https://api.securityscorecard.io/companies/scorecard\_identifier/history/events/effective\_date/issues/website\_copyright\_expired/ \\
