Get "site\_emits\_browser\_log" historical issues in
====================================================

get https://api.securityscorecard.io/companies/{scorecard\_identifier}/history/events/{effective\_date}/issues/site\_emits\_browser\_log/

Get "site\_emits\_browser\_log" historical issues in a scorecard
...
A page in a list of HistoricalSiteEmitsBrowserLogs
...
[Log in to use your API keys](/login?redirect_uri=/reference/get_companies-scorecard-identifier-history-events-effective-date-issues-site-emits-browser-log-1)
...
2
     ...
     \--url https://api.securityscorecard.io/companies/scorecard\_identifier/history/events/effective\_date/issues/site\_emits\_browser\_log/ \\
