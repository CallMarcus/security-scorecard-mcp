Get "tor\_traffic\_detected" issues in a scorecard
==================================================

get https://api.securityscorecard.io/companies/{scorecard\_identifier}/issues/tor\_traffic\_detected
...
A page in a list of TorTrafficDetecteds
...
[Log in to use your API keys](/login?redirect_uri=/reference/get_companies-scorecard-identifier-issues-tor-traffic-detected)
...
2
     ...
     \--url https://api.securityscorecard.io/companies/scorecard\_identifier/issues/tor\_traffic\_detected \\
