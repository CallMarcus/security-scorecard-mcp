Get "unsafe\_sri\_v2" issues in a scorecard
===========================================

get https://api.securityscorecard.io/companies/{scorecard\_identifier}/issues/unsafe\_sri\_v2
...
A page in a list of UnsafeSriV2s
...
[Log in to use your API keys](/login?redirect_uri=/reference/get_companies-scorecard-identifier-issues-unsafe-sri-v2-1)
...
2
     ...
     \--url https://api.securityscorecard.io/companies/scorecard\_identifier/issues/unsafe\_sri\_v2 \\
