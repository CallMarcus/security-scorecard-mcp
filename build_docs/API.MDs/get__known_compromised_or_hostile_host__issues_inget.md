Get "known\_compromised\_or\_hostile\_host" issues in
=====================================================

get https://api.securityscorecard.io/companies/{scorecard\_identifier}/issues/known\_compromised\_or\_hostile\_host

Get "known\_compromised\_or\_hostile\_host" issues in a scorecard
...
A page in a list of KnownCompromisedOrHostileHosts
...
[Log in to use your API keys](/login?redirect_uri=/reference/get_companies-scorecard-identifier-issues-known-compromised-or-hostile-host)
...
2
     ...
     \--url https://api.securityscorecard.io/companies/scorecard\_identifier/issues/known\_compromised\_or\_hostile\_host \\
