...
patch https://api.securityscorecard.io/custom-scorecards/{id}/filters
...
id of custom scorecard to add filters
...
[Log in to use your API keys](/login?redirect_uri=/reference/patch_custom-scorecards-id-filters)
