Get "ransomware\_association" issues in a scorecard
===================================================

get https://api.securityscorecard.io/companies/{scorecard\_identifier}/issues/ransomware\_association
...
A page in a list of RansomwareAssociations
...
[Log in to use your API keys](/login?redirect_uri=/reference/get_companies-scorecard-identifier-issues-ransomware-association-1)
...
2
     ...
     \--url https://api.securityscorecard.io/companies/scorecard\_identifier/issues/ransomware\_association \\
