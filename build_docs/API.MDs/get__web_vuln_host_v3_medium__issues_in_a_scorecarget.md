Get "web\_vuln\_host\_v3\_medium" issues in a scorecar
======================================================

get https://api.securityscorecard.io/companies/{scorecard\_identifier}/issues/web\_vuln\_host\_v3\_medium

Get "web\_vuln\_host\_v3\_medium" issues in a scorecard
...
A page in a list of WebVulnHostV3Mediums
...
[Log in to use your API keys](/login?redirect_uri=/reference/get_companies-scorecard-identifier-issues-web-vuln-host-v3-medium)
...
2
     ...
     \--url https://api.securityscorecard.io/companies/scorecard\_identifier/issues/web\_vuln\_host\_v3\_medium \\
