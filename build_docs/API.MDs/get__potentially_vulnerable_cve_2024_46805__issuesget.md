Get "potentially\_vulnerable\_cve\_2024\_46805" issues
======================================================

get https://api.securityscorecard.io/companies/{scorecard\_identifier}/issues/potentially\_vulnerable\_cve\_2024\_46805

Get "potentially\_vulnerable\_cve\_2024\_46805" issues in a scorecard
...
A page in a list of PotentiallyVulnerableCve202446805s
...
[Log in to use your API keys](/login?redirect_uri=/reference/get_companies-scorecard-identifier-issues-potentially-vulnerable-cve-2024-46805)
...
2
     ...
     \--url https://api.securityscorecard.io/companies/scorecard\_identifier/issues/potentially\_vulnerable\_cve\_2024\_46805 \\
