...
get https://api.securityscorecard.io/portfolios/{portfolio\_id}/companies
...
[Log in to use your API keys](/login?redirect_uri=/reference/get_portfolios-portfolio-id-companies)
...
2
     ...
     \--url https://api.securityscorecard.io/portfolios/portfolio\_id/companies \\
