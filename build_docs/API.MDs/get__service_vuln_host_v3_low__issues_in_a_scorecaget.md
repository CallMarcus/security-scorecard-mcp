Get "service\_vuln\_host\_v3\_low" issues in a scoreca
======================================================

get https://api.securityscorecard.io/companies/{scorecard\_identifier}/issues/service\_vuln\_host\_v3\_low

Get "service\_vuln\_host\_v3\_low" issues in a scorecard
...
A page in a list of ServiceVulnHostV3Lows
...
[Log in to use your API keys](/login?redirect_uri=/reference/get_companies-scorecard-identifier-issues-service-vuln-host-v3-low)
...
2
     ...
     \--url https://api.securityscorecard.io/companies/scorecard\_identifier/issues/service\_vuln\_host\_v3\_low \\
