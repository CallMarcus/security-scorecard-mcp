Get "browser\_logs\_contain\_debug\_message" issues in
======================================================

get https://api.securityscorecard.io/companies/{scorecard\_identifier}/issues/browser\_logs\_contain\_debug\_message

Get "browser\_logs\_contain\_debug\_message" issues in a scorecard
...
A page in a list of BrowserLogsContainDebugMessages
...
[Log in to use your API keys](/login?redirect_uri=/reference/get_companies-scorecard-identifier-issues-browser-logs-contain-debug-message)
...
2
     ...
     \--url https://api.securityscorecard.io/companies/scorecard\_identifier/issues/browser\_logs\_contain\_debug\_message \\
