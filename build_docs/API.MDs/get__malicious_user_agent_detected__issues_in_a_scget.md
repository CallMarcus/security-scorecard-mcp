Get "malicious\_user\_agent\_detected" issues in a sc
=====================================================

get https://api.securityscorecard.io/companies/{scorecard\_identifier}/issues/malicious\_user\_agent\_detected

Get "malicious\_user\_agent\_detected" issues in a scorecard
...
A page in a list of MaliciousUserAgentDetecteds
...
[Log in to use your API keys](/login?redirect_uri=/reference/get_companies-scorecard-identifier-issues-malicious-user-agent-detected)
...
2
     ...
     \--url https://api.securityscorecard.io/companies/scorecard\_identifier/issues/malicious\_user\_agent\_detected \\
