Get "tlscert\_self\_signed" issues in a scorecard
=================================================

get https://api.securityscorecard.io/companies/{scorecard\_identifier}/issues/tlscert\_self\_signed
...
A page in a list of TlscertSelfSigneds
...
[Log in to use your API keys](/login?redirect_uri=/reference/get_companies-scorecard-identifier-issues-tlscert-self-signed-1)
...
2
     ...
     \--url https://api.securityscorecard.io/companies/scorecard\_identifier/issues/tlscert\_self\_signed \\
