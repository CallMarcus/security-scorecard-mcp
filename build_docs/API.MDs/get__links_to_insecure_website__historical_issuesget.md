Get "links\_to\_insecure\_website" historical issues
====================================================

get https://api.securityscorecard.io/companies/{scorecard\_identifier}/history/events/{effective\_date}/issues/links\_to\_insecure\_website/

Get "links\_to\_insecure\_website" historical issues in a scorecard
...
A page in a list of HistoricalLinksToInsecureWebsites
...
[Log in to use your API keys](/login?redirect_uri=/reference/get_companies-scorecard-identifier-history-events-effective-date-issues-links-to-insecure-website-1)
...
2
     ...
     \--url https://api.securityscorecard.io/companies/scorecard\_identifier/history/events/effective\_date/issues/links\_to\_insecure\_website/ \\
