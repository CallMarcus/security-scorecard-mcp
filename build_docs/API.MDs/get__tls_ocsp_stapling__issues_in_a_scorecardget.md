Get "tls\_ocsp\_stapling" issues in a scorecard
===============================================

get https://api.securityscorecard.io/companies/{scorecard\_identifier}/issues/tls\_ocsp\_stapling
...
A page in a list of TlsOcspStaplings
...
[Log in to use your API keys](/login?redirect_uri=/reference/get_companies-scorecard-identifier-issues-tls-ocsp-stapling-1)
...
2
     ...
     \--url https://api.securityscorecard.io/companies/scorecard\_identifier/issues/tls\_ocsp\_stapling \\
