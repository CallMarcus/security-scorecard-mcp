Get "spf\_record\_malformed" issues in a scorecard
==================================================

get https://api.securityscorecard.io/companies/{scorecard\_identifier}/issues/spf\_record\_malformed
...
A page in a list of SpfRecordMalformeds
...
[Log in to use your API keys](/login?redirect_uri=/reference/get_companies-scorecard-identifier-issues-spf-record-malformed-1)
...
2
     ...
     \--url https://api.securityscorecard.io/companies/scorecard\_identifier/issues/spf\_record\_malformed \\
