...
get https://api.securityscorecard.io/vendor-detection/{domain}/fourth-party
...
[Log in to use your API keys](/login?redirect_uri=/reference/get_vendor-detection-domain-fourth-party)
...
2
     ...
     \--url 'https://api.securityscorecard.io/vendor-detection/domain/fourth-party?limit=100' \\
