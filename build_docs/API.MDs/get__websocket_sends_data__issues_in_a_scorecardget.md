Get "websocket\_sends\_data" issues in a scorecard
==================================================

get https://api.securityscorecard.io/companies/{scorecard\_identifier}/issues/websocket\_sends\_data
...
A page in a list of WebsocketSendsData
...
[Log in to use your API keys](/login?redirect_uri=/reference/get_companies-scorecard-identifier-issues-websocket-sends-data-1)
...
2
     ...
     \--url https://api.securityscorecard.io/companies/scorecard\_identifier/issues/websocket\_sends\_data \\
