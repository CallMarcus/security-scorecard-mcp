Get "mirai\_botnet\_traffic\_detected" issues in a sc
=====================================================

get https://api.securityscorecard.io/companies/{scorecard\_identifier}/issues/mirai\_botnet\_traffic\_detected

Get "mirai\_botnet\_traffic\_detected" issues in a scorecard
...
A page in a list of MiraiBotnetTrafficDetecteds
...
[Log in to use your API keys](/login?redirect_uri=/reference/get_companies-scorecard-identifier-issues-mirai-botnet-traffic-detected-1)
...
2
     ...
     \--url https://api.securityscorecard.io/companies/scorecard\_identifier/issues/mirai\_botnet\_traffic\_detected \\
