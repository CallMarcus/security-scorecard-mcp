Get "patching\_cadence\_v3\_critical" issues in a sco
=====================================================

get https://api.securityscorecard.io/companies/{scorecard\_identifier}/issues/patching\_cadence\_v3\_critical

Get "patching\_cadence\_v3\_critical" issues in a scorecard
...
A page in a list of PatchingCadenceV3Criticals
...
[Log in to use your API keys](/login?redirect_uri=/reference/get_companies-scorecard-identifier-issues-patching-cadence-v3-critical)
...
2
     ...
     \--url https://api.securityscorecard.io/companies/scorecard\_identifier/issues/patching\_cadence\_v3\_critical \\
