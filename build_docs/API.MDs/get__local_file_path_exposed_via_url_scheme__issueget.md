Get "local\_file\_path\_exposed\_via\_url\_scheme" issue
========================================================

get https://api.securityscorecard.io/companies/{scorecard\_identifier}/issues/local\_file\_path\_exposed\_via\_url\_scheme

Get "local\_file\_path\_exposed\_via\_url\_scheme" issues in a scorecard
...
A page in a list of LocalFilePathExposedViaUrlSchemes
...
[Log in to use your API keys](/login?redirect_uri=/reference/get_companies-scorecard-identifier-issues-local-file-path-exposed-via-url-scheme)
...
2
     ...
     \--url https://api.securityscorecard.io/companies/scorecard\_identifier/issues/local\_file\_path\_exposed\_via\_url\_scheme \\
