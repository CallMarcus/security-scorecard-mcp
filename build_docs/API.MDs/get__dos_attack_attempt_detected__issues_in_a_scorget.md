Get "dos\_attack\_attempt\_detected" issues in a scor
=====================================================

get https://api.securityscorecard.io/companies/{scorecard\_identifier}/issues/dos\_attack\_attempt\_detected

Get "dos\_attack\_attempt\_detected" issues in a scorecard
...
A page in a list of DosAttackAttemptDetecteds
...
[Log in to use your API keys](/login?redirect_uri=/reference/get_companies-scorecard-identifier-issues-dos-attack-attempt-detected)
...
2
     ...
     \--url https://api.securityscorecard.io/companies/scorecard\_identifier/issues/dos\_attack\_attempt\_detected \\
