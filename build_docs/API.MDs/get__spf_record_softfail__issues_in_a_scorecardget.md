Get "spf\_record\_softfail" issues in a scorecard
=================================================

get https://api.securityscorecard.io/companies/{scorecard\_identifier}/issues/spf\_record\_softfail
...
[Log in to use your API keys](/login?redirect_uri=/reference/get_companies-scorecard-identifier-issues-spf-record-softfail-1)
...
2
     ...
     \--url https://api.securityscorecard.io/companies/scorecard\_identifier/issues/spf\_record\_softfail \\
