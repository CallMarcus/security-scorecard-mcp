Get "web\_vuln\_host\_low" issues in a scorecard
================================================

get https://api.securityscorecard.io/companies/{scorecard\_identifier}/issues/web\_vuln\_host\_low
...
A page in a list of WebVulnHostLows
...
[Log in to use your API keys](/login?redirect_uri=/reference/get_companies-scorecard-identifier-issues-web-vuln-host-low-1)
...
2
     ...
     \--url https://api.securityscorecard.io/companies/scorecard\_identifier/issues/web\_vuln\_host\_low \\
