Get "service\_vuln\_host\_v3\_medium" issues in a scor
======================================================

get https://api.securityscorecard.io/companies/{scorecard\_identifier}/issues/service\_vuln\_host\_v3\_medium

Get "service\_vuln\_host\_v3\_medium" issues in a scorecard
...
A page in a list of ServiceVulnHostV3Mediums
...
[Log in to use your API keys](/login?redirect_uri=/reference/get_companies-scorecard-identifier-issues-service-vuln-host-v3-medium)
...
2
     ...
     \--url https://api.securityscorecard.io/companies/scorecard\_identifier/issues/service\_vuln\_host\_v3\_medium \\
