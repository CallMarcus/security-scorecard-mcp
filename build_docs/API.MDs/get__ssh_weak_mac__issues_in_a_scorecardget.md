Get "ssh\_weak\_mac" issues in a scorecard
==========================================

get https://api.securityscorecard.io/companies/{scorecard\_identifier}/issues/ssh\_weak\_mac
...
A page in a list of SshWeakMacs
...
[Log in to use your API keys](/login?redirect_uri=/reference/get_companies-scorecard-identifier-issues-ssh-weak-mac-1)
...
2
     ...
     \--url https://api.securityscorecard.io/companies/scorecard\_identifier/issues/ssh\_weak\_mac \\
