Get "compromised\_credentials\_found" issues in a sc
====================================================

get https://api.securityscorecard.io/companies/{scorecard\_identifier}/issues/compromised\_credentials\_found

Get "compromised\_credentials\_found" issues in a scorecard
...
A page in a list of CompromisedCredentialsFounds
...
[Log in to use your API keys](/login?redirect_uri=/reference/get_companies-scorecard-identifier-issues-compromised-credentials-found)
...
2
     ...
     \--url https://api.securityscorecard.io/companies/scorecard\_identifier/issues/compromised\_credentials\_found \\
