Get "patching\_cadence\_v3\_medium" issues in a score
=====================================================

get https://api.securityscorecard.io/companies/{scorecard\_identifier}/issues/patching\_cadence\_v3\_medium

Get "patching\_cadence\_v3\_medium" issues in a scorecard
...
A page in a list of PatchingCadenceV3Mediums
...
[Log in to use your API keys](/login?redirect_uri=/reference/get_companies-scorecard-identifier-issues-patching-cadence-v3-medium)
...
2
     ...
     \--url https://api.securityscorecard.io/companies/scorecard\_identifier/issues/patching\_cadence\_v3\_medium \\
