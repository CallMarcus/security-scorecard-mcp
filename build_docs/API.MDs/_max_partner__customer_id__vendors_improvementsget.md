/max/partner/{customer\_id}/vendors-improvements
================================================

get https://api.securityscorecard.io/max/partner/{customer\_id}/vendors-improvements
...
[Log in to use your API keys](/login?redirect_uri=/reference/get_max-partner-customer-id-vendors-improvements)
...
2
     ...
     \--url https://api.securityscorecard.io/max/partner/customer\_id/vendors-improvements \\
