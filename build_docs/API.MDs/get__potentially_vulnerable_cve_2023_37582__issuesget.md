Get "potentially\_vulnerable\_cve\_2023\_37582" issues
======================================================

get https://api.securityscorecard.io/companies/{scorecard\_identifier}/issues/potentially\_vulnerable\_cve\_2023\_37582

Get "potentially\_vulnerable\_cve\_2023\_37582" issues in a scorecard
...
A page in a list of PotentiallyVulnerableCve202337582s
...
[Log in to use your API keys](/login?redirect_uri=/reference/get_companies-scorecard-identifier-issues-potentially-vulnerable-cve-2023-37582)
...
2
     ...
     \--url https://api.securityscorecard.io/companies/scorecard\_identifier/issues/potentially\_vulnerable\_cve\_2023\_37582 \\
