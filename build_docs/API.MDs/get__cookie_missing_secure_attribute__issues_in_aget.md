Get "cookie\_missing\_secure\_attribute" issues in a
====================================================

get https://api.securityscorecard.io/companies/{scorecard\_identifier}/issues/cookie\_missing\_secure\_attribute

Get "cookie\_missing\_secure\_attribute" issues in a scorecard
...
[Log in to use your API keys](/login?redirect_uri=/reference/get_companies-scorecard-identifier-issues-cookie-missing-secure-attribute)
...
2
     ...
     \--url https://api.securityscorecard.io/companies/scorecard\_identifier/issues/cookie\_missing\_secure\_attribute \\
