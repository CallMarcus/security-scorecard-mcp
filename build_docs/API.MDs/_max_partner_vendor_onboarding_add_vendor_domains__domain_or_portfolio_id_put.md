...
put https://api.securityscorecard.io/max/partner/vendor-onboarding/add-vendor-domains/{domain\_or\_portfolio\_id}

Add vendor domains via CSV upload
...
[Log in to use your API keys](/login?redirect_uri=/reference/put_max-partner-vendor-onboarding-add-vendor-domains-domain-or-portfolio-id)
