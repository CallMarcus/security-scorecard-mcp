Get "patching\_analysis\_medium" issues in a scoreca
====================================================

get https://api.securityscorecard.io/companies/{scorecard\_identifier}/issues/patching\_analysis\_medium

Get "patching\_analysis\_medium" issues in a scorecard
...
A page in a list of PatchingAnalysisMediums
...
[Log in to use your API keys](/login?redirect_uri=/reference/get_companies-scorecard-identifier-issues-patching-analysis-medium-1)
...
2
     ...
     \--url https://api.securityscorecard.io/companies/scorecard\_identifier/issues/patching\_analysis\_medium \\
