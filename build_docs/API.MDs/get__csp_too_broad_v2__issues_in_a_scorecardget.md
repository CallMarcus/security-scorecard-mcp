Get "csp\_too\_broad\_v2" issues in a scorecard
===============================================

get https://api.securityscorecard.io/companies/{scorecard\_identifier}/issues/csp\_too\_broad\_v2
...
A page in a list of CspTooBroadV2s
...
[Log in to use your API keys](/login?redirect_uri=/reference/get_companies-scorecard-identifier-issues-csp-too-broad-v2)
...
2
     ...
     \--url https://api.securityscorecard.io/companies/scorecard\_identifier/issues/csp\_too\_broad\_v2 \\
