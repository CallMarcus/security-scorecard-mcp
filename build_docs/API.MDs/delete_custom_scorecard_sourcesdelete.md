...
delete https://api.securityscorecard.io/custom-scorecards/{id}/sources
...
id of custom scorecard to delete sources
...
[Log in to use your API keys](/login?redirect_uri=/reference/delete_custom-scorecards-id-sources)
