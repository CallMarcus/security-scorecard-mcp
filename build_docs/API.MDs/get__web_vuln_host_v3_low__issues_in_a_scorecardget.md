Get "web\_vuln\_host\_v3\_low" issues in a scorecard
====================================================

get https://api.securityscorecard.io/companies/{scorecard\_identifier}/issues/web\_vuln\_host\_v3\_low
...
A page in a list of WebVulnHostV3Lows
...
[Log in to use your API keys](/login?redirect_uri=/reference/get_companies-scorecard-identifier-issues-web-vuln-host-v3-low)
...
2
     ...
     \--url https://api.securityscorecard.io/companies/scorecard\_identifier/issues/web\_vuln\_host\_v3\_low \\
