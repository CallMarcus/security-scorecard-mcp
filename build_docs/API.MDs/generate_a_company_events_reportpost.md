...
post https://api.securityscorecard.io/reports/events-json
...
[Log in to use your API keys](/login?redirect_uri=/reference/post_reports-events-json-1)
...
2
     ...
     \--url https://api.securityscorecard.io/reports/events-json \\
