Get "malicious\_tor\_exit\_node\_detected" issues in a
======================================================

get https://api.securityscorecard.io/companies/{scorecard\_identifier}/issues/malicious\_tor\_exit\_node\_detected

Get "malicious\_tor\_exit\_node\_detected" issues in a scorecard
...
A page in a list of MaliciousTorExitNodeDetecteds
...
[Log in to use your API keys](/login?redirect_uri=/reference/get_companies-scorecard-identifier-issues-malicious-tor-exit-node-detected)
...
2
     ...
     \--url https://api.securityscorecard.io/companies/scorecard\_identifier/issues/malicious\_tor\_exit\_node\_detected \\
