Get "web\_vuln\_host\_v3\_critical" historical issues
=====================================================

get https://api.securityscorecard.io/companies/{scorecard\_identifier}/history/events/{effective\_date}/issues/web\_vuln\_host\_v3\_critical/

Get "web\_vuln\_host\_v3\_critical" historical issues in a scorecard
...
A page in a list of HistoricalWebVulnHostV3Criticals
...
[Log in to use your API keys](/login?redirect_uri=/reference/get_companies-scorecard-identifier-history-events-effective-date-issues-web-vuln-host-v3-critical)
...
2
     ...
     \--url https://api.securityscorecard.io/companies/scorecard\_identifier/history/events/effective\_date/issues/web\_vuln\_host\_v3\_critical/ \\
