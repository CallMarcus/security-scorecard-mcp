Get "web\_vuln\_host\_v3\_critical" issues in a scorec
======================================================

get https://api.securityscorecard.io/companies/{scorecard\_identifier}/issues/web\_vuln\_host\_v3\_critical

Get "web\_vuln\_host\_v3\_critical" issues in a scorecard
...
A page in a list of WebVulnHostV3Criticals
...
[Log in to use your API keys](/login?redirect_uri=/reference/get_companies-scorecard-identifier-issues-web-vuln-host-v3-critical)
...
2
     ...
     \--url https://api.securityscorecard.io/companies/scorecard\_identifier/issues/web\_vuln\_host\_v3\_critical \\
