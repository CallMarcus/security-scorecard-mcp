Get "service\_vuln\_host\_v3\_high" issues in a scorec
======================================================

get https://api.securityscorecard.io/companies/{scorecard\_identifier}/issues/service\_vuln\_host\_v3\_high

Get "service\_vuln\_host\_v3\_high" issues in a scorecard
...
A page in a list of ServiceVulnHostV3Highs
...
[Log in to use your API keys](/login?redirect_uri=/reference/get_companies-scorecard-identifier-issues-service-vuln-host-v3-high)
...
2
     ...
     \--url https://api.securityscorecard.io/companies/scorecard\_identifier/issues/service\_vuln\_host\_v3\_high \\
