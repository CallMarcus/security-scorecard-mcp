Get "ransomware\_association" historical issues in
==================================================

get https://api.securityscorecard.io/companies/{scorecard\_identifier}/history/events/{effective\_date}/issues/ransomware\_association/

Get "ransomware\_association" historical issues in a scorecard
...
A page in a list of HistoricalRansomwareAssociations
...
[Log in to use your API keys](/login?redirect_uri=/reference/get_companies-scorecard-identifier-history-events-effective-date-issues-ransomware-association-1)
...
2
     ...
     \--url https://api.securityscorecard.io/companies/scorecard\_identifier/history/events/effective\_date/issues/ransomware\_association/ \\
