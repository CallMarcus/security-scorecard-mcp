Get "mysql\_server\_empty\_password" issues in a scor
=====================================================

get https://api.securityscorecard.io/companies/{scorecard\_identifier}/issues/mysql\_server\_empty\_password

Get "mysql\_server\_empty\_password" issues in a scorecard
...
A page in a list of MysqlServerEmptyPasswords
...
[Log in to use your API keys](/login?redirect_uri=/reference/get_companies-scorecard-identifier-issues-mysql-server-empty-password-1)
...
2
     ...
     \--url https://api.securityscorecard.io/companies/scorecard\_identifier/issues/mysql\_server\_empty\_password \\
