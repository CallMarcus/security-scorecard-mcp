...
get https://api.securityscorecard.io/max/customer/reports/remediation-plans
...
[Log in to use your API keys](/login?redirect_uri=/reference/get_max-customer-reports-remediation-plans)
...
2
     ...
     \--url https://api.securityscorecard.io/max/customer/reports/remediation-plans \\
