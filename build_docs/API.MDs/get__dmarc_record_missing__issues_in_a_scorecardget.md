Get "dmarc\_record\_missing" issues in a scorecard
==================================================

get https://api.securityscorecard.io/companies/{scorecard\_identifier}/issues/dmarc\_record\_missing
...
A page in a list of DmarcRecordMissings
...
[Log in to use your API keys](/login?redirect_uri=/reference/get_companies-scorecard-identifier-issues-dmarc-record-missing)
...
2
     ...
     \--url https://api.securityscorecard.io/companies/scorecard\_identifier/issues/dmarc\_record\_missing \\
