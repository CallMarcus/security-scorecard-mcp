...
post https://api.securityscorecard.io/reports/partnership
...
[Log in to use your API keys](/login?redirect_uri=/reference/post_reports-partnership-1)
...
2
     ...
     \--url https://api.securityscorecard.io/reports/partnership \\
