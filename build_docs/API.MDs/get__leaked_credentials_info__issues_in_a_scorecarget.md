Get "leaked\_credentials\_info" issues in a scorecar
====================================================

get https://api.securityscorecard.io/companies/{scorecard\_identifier}/issues/leaked\_credentials\_info

Get "leaked\_credentials\_info" issues in a scorecard
...
A page in a list of LeakedCredentialsInfos
...
[Log in to use your API keys](/login?redirect_uri=/reference/get_companies-scorecard-identifier-issues-leaked-credentials-info)
...
2
     ...
     \--url https://api.securityscorecard.io/companies/scorecard\_identifier/issues/leaked\_credentials\_info \\
