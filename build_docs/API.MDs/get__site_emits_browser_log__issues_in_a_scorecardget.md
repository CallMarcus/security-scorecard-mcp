Get "site\_emits\_browser\_log" issues in a scorecard
=====================================================

get https://api.securityscorecard.io/companies/{scorecard\_identifier}/issues/site\_emits\_browser\_log
...
A page in a list of SiteEmitsBrowserLogs
...
[Log in to use your API keys](/login?redirect_uri=/reference/get_companies-scorecard-identifier-issues-site-emits-browser-log-1)
...
2
     ...
     \--url https://api.securityscorecard.io/companies/scorecard\_identifier/issues/site\_emits\_browser\_log \\
