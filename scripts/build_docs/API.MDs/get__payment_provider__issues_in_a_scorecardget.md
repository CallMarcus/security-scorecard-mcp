Get "payment\_provider" issues in a scorecard
=============================================

get https://api.securityscorecard.io/companies/{scorecard\_identifier}/issues/payment\_provider
...
A page in a list of PaymentProviders
...
[Log in to use your API keys](/login?redirect_uri=/reference/get_companies-scorecard-identifier-issues-payment-provider-1)
...
2
     ...
     \--url https://api.securityscorecard.io/companies/scorecard\_identifier/issues/payment\_provider \\
