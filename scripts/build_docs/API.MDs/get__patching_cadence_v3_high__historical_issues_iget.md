Get "patching\_cadence\_v3\_high" historical issues i
=====================================================

get https://api.securityscorecard.io/companies/{scorecard\_identifier}/history/events/{effective\_date}/issues/patching\_cadence\_v3\_high/

Get "patching\_cadence\_v3\_high" historical issues in a scorecard
...
A page in a list of HistoricalPatchingCadenceV3Highs
...
[Log in to use your API keys](/login?redirect_uri=/reference/get_companies-scorecard-identifier-history-events-effective-date-issues-patching-cadence-v3-high)
...
2
     ...
     \--url https://api.securityscorecard.io/companies/scorecard\_identifier/history/events/effective\_date/issues/patching\_cadence\_v3\_high/ \\
