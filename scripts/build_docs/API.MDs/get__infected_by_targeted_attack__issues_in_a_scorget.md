Get "infected\_by\_targeted\_attack" issues in a scor
=====================================================

get https://api.securityscorecard.io/companies/{scorecard\_identifier}/issues/infected\_by\_targeted\_attack

Get "infected\_by\_targeted\_attack" issues in a scorecard
...
[Log in to use your API keys](/login?redirect_uri=/reference/get_companies-scorecard-identifier-issues-infected-by-targeted-attack)
...
2
     ...
     \--url https://api.securityscorecard.io/companies/scorecard\_identifier/issues/infected\_by\_targeted\_attack \\
