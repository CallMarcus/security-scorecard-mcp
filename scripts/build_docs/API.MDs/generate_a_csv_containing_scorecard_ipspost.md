...
post https://api.securityscorecard.io/reports/footprint-ips
...
[Log in to use your API keys](/login?redirect_uri=/reference/post_reports-footprint-ips-1)
...
2
     ...
     \--url https://api.securityscorecard.io/reports/footprint-ips \\
