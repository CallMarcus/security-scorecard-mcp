Get "potentially\_vulnerable\_cisco\_rv\_320\_325" issu
=======================================================

get https://api.securityscorecard.io/companies/{scorecard\_identifier}/issues/potentially\_vulnerable\_cisco\_rv\_320\_325

Get "potentially\_vulnerable\_cisco\_rv\_320\_325" issues in a scorecard
...
A page in a list of PotentiallyVulnerableCiscoRv320325s
...
[Log in to use your API keys](/login?redirect_uri=/reference/get_companies-scorecard-identifier-issues-potentially-vulnerable-cisco-rv-320-325)
...
2
     ...
     \--url https://api.securityscorecard.io/companies/scorecard\_identifier/issues/potentially\_vulnerable\_cisco\_rv\_320\_325 \\
