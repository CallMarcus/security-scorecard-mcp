Get "website\_copyright\_expired" issues in a scorec
====================================================

get https://api.securityscorecard.io/companies/{scorecard\_identifier}/issues/website\_copyright\_expired

Get "website\_copyright\_expired" issues in a scorecard
...
A page in a list of WebsiteCopyrightExpireds
...
[Log in to use your API keys](/login?redirect_uri=/reference/get_companies-scorecard-identifier-issues-website-copyright-expired-1)
...
2
     ...
     \--url https://api.securityscorecard.io/companies/scorecard\_identifier/issues/website\_copyright\_expired \\
