Get "web\_vuln\_host\_low" historical issues in a sco
=====================================================

get https://api.securityscorecard.io/companies/{scorecard\_identifier}/history/events/{effective\_date}/issues/web\_vuln\_host\_low/

Get "web\_vuln\_host\_low" historical issues in a scorecard
...
A page in a list of HistoricalWebVulnHostLows
...
[Log in to use your API keys](/login?redirect_uri=/reference/get_companies-scorecard-identifier-history-events-effective-date-issues-web-vuln-host-low-1)
...
2
     ...
     \--url https://api.securityscorecard.io/companies/scorecard\_identifier/history/events/effective\_date/issues/web\_vuln\_host\_low/ \\
