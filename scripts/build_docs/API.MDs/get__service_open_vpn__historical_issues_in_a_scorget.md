Get "service\_open\_vpn" historical issues in a scor
====================================================

get https://api.securityscorecard.io/companies/{scorecard\_identifier}/history/events/{effective\_date}/issues/service\_open\_vpn/

Get "service\_open\_vpn" historical issues in a scorecard
...
A page in a list of HistoricalServiceOpenVpns
...
[Log in to use your API keys](/login?redirect_uri=/reference/get_companies-scorecard-identifier-history-events-effective-date-issues-service-open-vpn-1)
...
2
     ...
     \--url https://api.securityscorecard.io/companies/scorecard\_identifier/history/events/effective\_date/issues/service\_open\_vpn/ \\
