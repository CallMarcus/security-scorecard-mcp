Get "mail\_server\_unusual\_port" issues in a scoreca
=====================================================

get https://api.securityscorecard.io/companies/{scorecard\_identifier}/issues/mail\_server\_unusual\_port

Get "mail\_server\_unusual\_port" issues in a scorecard
...
A page in a list of MailServerUnusualPorts
...
[Log in to use your API keys](/login?redirect_uri=/reference/get_companies-scorecard-identifier-issues-mail-server-unusual-port)
...
2
     ...
     \--url https://api.securityscorecard.io/companies/scorecard\_identifier/issues/mail\_server\_unusual\_port \\
