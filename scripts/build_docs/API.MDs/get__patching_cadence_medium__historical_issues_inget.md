Get "patching\_cadence\_medium" historical issues in
====================================================

get https://api.securityscorecard.io/companies/{scorecard\_identifier}/history/events/{effective\_date}/issues/patching\_cadence\_medium/

Get "patching\_cadence\_medium" historical issues in a scorecard
...
A page in a list of HistoricalPatchingCadenceMediums
...
[Log in to use your API keys](/login?redirect_uri=/reference/get_companies-scorecard-identifier-history-events-effective-date-issues-patching-cadence-medium-1)
...
2
     ...
     \--url https://api.securityscorecard.io/companies/scorecard\_identifier/history/events/effective\_date/issues/patching\_cadence\_medium/ \\
