Get "dmarc\_contains\_none" issues in a scorecard
=================================================

get https://api.securityscorecard.io/companies/{scorecard\_identifier}/issues/dmarc\_contains\_none
...
A page in a list of DmarcContainsNones
...
[Log in to use your API keys](/login?redirect_uri=/reference/get_companies-scorecard-identifier-issues-dmarc-contains-none)
...
2
     ...
     \--url https://api.securityscorecard.io/companies/scorecard\_identifier/issues/dmarc\_contains\_none \\
