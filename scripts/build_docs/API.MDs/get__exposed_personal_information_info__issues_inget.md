Get "exposed\_personal\_information\_info" issues in
====================================================

get https://api.securityscorecard.io/companies/{scorecard\_identifier}/issues/exposed\_personal\_information\_info

Get "exposed\_personal\_information\_info" issues in a scorecard
...
A page in a list of ExposedPersonalInformationInfos
...
[Log in to use your API keys](/login?redirect_uri=/reference/get_companies-scorecard-identifier-issues-exposed-personal-information-info)
...
2
     ...
     \--url https://api.securityscorecard.io/companies/scorecard\_identifier/issues/exposed\_personal\_information\_info \\
