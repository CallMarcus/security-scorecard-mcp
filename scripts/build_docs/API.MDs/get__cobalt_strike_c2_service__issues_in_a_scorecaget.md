Get "cobalt\_strike\_c2\_service" issues in a scoreca
=====================================================

get https://api.securityscorecard.io/companies/{scorecard\_identifier}/issues/cobalt\_strike\_c2\_service

Get "cobalt\_strike\_c2\_service" issues in a scorecard
...
A page in a list of CobaltStrikeC2Services
...
[Log in to use your API keys](/login?redirect_uri=/reference/get_companies-scorecard-identifier-issues-cobalt-strike-c2-service)
...
2
     ...
     \--url https://api.securityscorecard.io/companies/scorecard\_identifier/issues/cobalt\_strike\_c2\_service \\
