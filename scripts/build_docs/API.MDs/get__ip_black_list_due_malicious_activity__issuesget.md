Get "ip\_black\_list\_due\_malicious\_activity" issues
======================================================

get https://api.securityscorecard.io/companies/{scorecard\_identifier}/issues/ip\_black\_list\_due\_malicious\_activity

Get "ip\_black\_list\_due\_malicious\_activity" issues in a scorecard
...
A page in a list of IpBlackListDueMaliciousActivities
...
[Log in to use your API keys](/login?redirect_uri=/reference/get_companies-scorecard-identifier-issues-ip-black-list-due-malicious-activity)
...
2
     ...
     \--url https://api.securityscorecard.io/companies/scorecard\_identifier/issues/ip\_black\_list\_due\_malicious\_activity \\
