Get "service\_microsoft\_sql" issues in a scorecard
===================================================

get https://api.securityscorecard.io/companies/{scorecard\_identifier}/issues/service\_microsoft\_sql
...
A page in a list of ServiceMicrosoftSqls
...
[Log in to use your API keys](/login?redirect_uri=/reference/get_companies-scorecard-identifier-issues-service-microsoft-sql-1)
...
2
     ...
     \--url https://api.securityscorecard.io/companies/scorecard\_identifier/issues/service\_microsoft\_sql \\
