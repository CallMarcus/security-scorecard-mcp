Get "uses\_go\_daddy\_infrastructure" issues in a sco
=====================================================

get https://api.securityscorecard.io/companies/{scorecard\_identifier}/issues/uses\_go\_daddy\_infrastructure

Get "uses\_go\_daddy\_infrastructure" issues in a scorecard
...
A page in a list of UsesGoDaddyInfrastructures
...
[Log in to use your API keys](/login?redirect_uri=/reference/get_companies-scorecard-identifier-issues-uses-go-daddy-infrastructure-1)
...
2
     ...
     \--url https://api.securityscorecard.io/companies/scorecard\_identifier/issues/uses\_go\_daddy\_infrastructure \\
