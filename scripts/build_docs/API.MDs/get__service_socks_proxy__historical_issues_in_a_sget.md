Get "service\_socks\_proxy" historical issues in a s
====================================================

get https://api.securityscorecard.io/companies/{scorecard\_identifier}/history/events/{effective\_date}/issues/service\_socks\_proxy/

Get "service\_socks\_proxy" historical issues in a scorecard
...
A page in a list of HistoricalServiceSocksProxies
...
[Log in to use your API keys](/login?redirect_uri=/reference/get_companies-scorecard-identifier-history-events-effective-date-issues-service-socks-proxy-1)
...
2
     ...
     \--url https://api.securityscorecard.io/companies/scorecard\_identifier/history/events/effective\_date/issues/service\_socks\_proxy/ \\
