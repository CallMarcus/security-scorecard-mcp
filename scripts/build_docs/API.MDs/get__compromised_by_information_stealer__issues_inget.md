Get "compromised\_by\_information\_stealer" issues in
=====================================================

get https://api.securityscorecard.io/companies/{scorecard\_identifier}/issues/compromised\_by\_information\_stealer

Get "compromised\_by\_information\_stealer" issues in a scorecard
...
[Log in to use your API keys](/login?redirect_uri=/reference/get_companies-scorecard-identifier-issues-compromised-by-information-stealer)
...
2
     ...
     \--url https://api.securityscorecard.io/companies/scorecard\_identifier/issues/compromised\_by\_information\_stealer \\
