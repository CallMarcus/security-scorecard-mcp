Get "cve\_in\_use\_by\_threat\_actor" historical issues
=======================================================

get https://api.securityscorecard.io/companies/{scorecard\_identifier}/history/events/{effective\_date}/issues/cve\_in\_use\_by\_threat\_actor/

Get "cve\_in\_use\_by\_threat\_actor" historical issues in a scorecard
...
A page in a list of HistoricalCveInUseByThreatActors
...
[Log in to use your API keys](/login?redirect_uri=/reference/get_companies-scorecard-identifier-history-events-effective-date-issues-cve-in-use-by-threat-actor-1)
...
2
     ...
     \--url https://api.securityscorecard.io/companies/scorecard\_identifier/history/events/effective\_date/issues/cve\_in\_use\_by\_threat\_actor/ \\
