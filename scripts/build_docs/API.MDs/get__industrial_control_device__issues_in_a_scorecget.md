Get "industrial\_control\_device" issues in a scorec
====================================================

get https://api.securityscorecard.io/companies/{scorecard\_identifier}/issues/industrial\_control\_device

Get "industrial\_control\_device" issues in a scorecard
...
A page in a list of IndustrialControlDevices
...
[Log in to use your API keys](/login?redirect_uri=/reference/get_companies-scorecard-identifier-issues-industrial-control-device)
...
2
     ...
     \--url https://api.securityscorecard.io/companies/scorecard\_identifier/issues/industrial\_control\_device \\
