Get "patching\_analysis\_low" issues in a scorecard
===================================================

get https://api.securityscorecard.io/companies/{scorecard\_identifier}/issues/patching\_analysis\_low
...
A page in a list of PatchingAnalysisLows
...
[Log in to use your API keys](/login?redirect_uri=/reference/get_companies-scorecard-identifier-issues-patching-analysis-low-1)
...
2
     ...
     \--url https://api.securityscorecard.io/companies/scorecard\_identifier/issues/patching\_analysis\_low \\
