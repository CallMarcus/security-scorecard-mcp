Get "malicious\_scan\_detected" historical issues in
====================================================

get https://api.securityscorecard.io/companies/{scorecard\_identifier}/history/events/{effective\_date}/issues/malicious\_scan\_detected/

Get "malicious\_scan\_detected" historical issues in a scorecard
...
A page in a list of HistoricalMaliciousScanDetecteds
...
[Log in to use your API keys](/login?redirect_uri=/reference/get_companies-scorecard-identifier-history-events-effective-date-issues-malicious-scan-detected-1)
...
2
     ...
     \--url https://api.securityscorecard.io/companies/scorecard\_identifier/history/events/effective\_date/issues/malicious\_scan\_detected/ \\
