...
get https://api.securityscorecard.io/companies/{scorecard\_identifier}/issues/typosquat
...
[Log in to use your API keys](/login?redirect_uri=/reference/get_companies-scorecard-identifier-issues-typosquat)
...
2
     ...
     \--url https://api.securityscorecard.io/companies/scorecard\_identifier/issues/typosquat \\
