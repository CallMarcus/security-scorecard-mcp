Get "insecure\_ftp" historical issues in a scorecar
===================================================

get https://api.securityscorecard.io/companies/{scorecard\_identifier}/history/events/{effective\_date}/issues/insecure\_ftp/

Get "insecure\_ftp" historical issues in a scorecard
...
A page in a list of HistoricalInsecureFtps
...
[Log in to use your API keys](/login?redirect_uri=/reference/get_companies-scorecard-identifier-history-events-effective-date-issues-insecure-ftp-1)
...
2
     ...
     \--url https://api.securityscorecard.io/companies/scorecard\_identifier/history/events/effective\_date/issues/insecure\_ftp/ \\
