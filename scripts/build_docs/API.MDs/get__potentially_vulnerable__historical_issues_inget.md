Get "potentially\_vulnerable" historical issues in
==================================================

get https://api.securityscorecard.io/companies/{scorecard\_identifier}/history/events/{effective\_date}/issues/potentially\_vulnerable/

Get "potentially\_vulnerable" historical issues in a scorecard
...
A page in a list of HistoricalPotentiallyVulnerables
...
[Log in to use your API keys](/login?redirect_uri=/reference/get_companies-scorecard-identifier-history-events-effective-date-issues-potentially-vulnerable-1)
...
2
     ...
     \--url https://api.securityscorecard.io/companies/scorecard\_identifier/history/events/effective\_date/issues/potentially\_vulnerable/ \\
