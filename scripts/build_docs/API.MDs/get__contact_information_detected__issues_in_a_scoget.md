Get "contact\_information\_detected" issues in a sco
====================================================

get https://api.securityscorecard.io/companies/{scorecard\_identifier}/issues/contact\_information\_detected

Get "contact\_information\_detected" issues in a scorecard
...
A page in a list of ContactInformationDetecteds
...
[Log in to use your API keys](/login?redirect_uri=/reference/get_companies-scorecard-identifier-issues-contact-information-detected)
...
2
     ...
     \--url https://api.securityscorecard.io/companies/scorecard\_identifier/issues/contact\_information\_detected \\
