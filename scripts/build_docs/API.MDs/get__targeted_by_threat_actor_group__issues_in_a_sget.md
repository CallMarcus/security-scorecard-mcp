Get "targeted\_by\_threat\_actor\_group" issues in a s
======================================================

get https://api.securityscorecard.io/companies/{scorecard\_identifier}/issues/targeted\_by\_threat\_actor\_group

Get "targeted\_by\_threat\_actor\_group" issues in a scorecard
...
[Log in to use your API keys](/login?redirect_uri=/reference/get_companies-scorecard-identifier-issues-targeted-by-threat-actor-group)
...
2
     ...
     \--url https://api.securityscorecard.io/companies/scorecard\_identifier/issues/targeted\_by\_threat\_actor\_group \\
