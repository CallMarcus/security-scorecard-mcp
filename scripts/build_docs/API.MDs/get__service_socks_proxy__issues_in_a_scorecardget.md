Get "service\_socks\_proxy" issues in a scorecard
=================================================

get https://api.securityscorecard.io/companies/{scorecard\_identifier}/issues/service\_socks\_proxy
...
A page in a list of ServiceSocksProxies
...
[Log in to use your API keys](/login?redirect_uri=/reference/get_companies-scorecard-identifier-issues-service-socks-proxy-1)
...
2
     ...
     \--url https://api.securityscorecard.io/companies/scorecard\_identifier/issues/service\_socks\_proxy \\
