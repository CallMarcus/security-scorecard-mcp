...
get https://api.securityscorecard.io/custom-scorecards/{id}
...
[Log in to use your API keys](/login?redirect_uri=/reference/get_custom-scorecards-id)
...
2
     ...
     \--url https://api.securityscorecard.io/custom-scorecards/id \\
