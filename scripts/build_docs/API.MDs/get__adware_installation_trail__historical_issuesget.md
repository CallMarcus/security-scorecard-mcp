Get "adware\_installation\_trail" historical issues
===================================================

get https://api.securityscorecard.io/companies/{scorecard\_identifier}/history/events/{effective\_date}/issues/adware\_installation\_trail/

Get "adware\_installation\_trail" historical issues in a scorecard
...
A page in a list of HistoricalAdwareInstallationTrails
...
[Log in to use your API keys](/login?redirect_uri=/reference/get_companies-scorecard-identifier-history-events-effective-date-issues-adware-installation-trail-1)
...
2
     ...
     \--url https://api.securityscorecard.io/companies/scorecard\_identifier/history/events/effective\_date/issues/adware\_installation\_trail/ \\
