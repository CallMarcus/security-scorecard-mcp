Get "redirect\_to\_insecure\_website" issues in a sco
=====================================================

get https://api.securityscorecard.io/companies/{scorecard\_identifier}/issues/redirect\_to\_insecure\_website

Get "redirect\_to\_insecure\_website" issues in a scorecard
...
A page in a list of RedirectToInsecureWebsites
...
[Log in to use your API keys](/login?redirect_uri=/reference/get_companies-scorecard-identifier-issues-redirect-to-insecure-website-1)
...
2
     ...
     \--url https://api.securityscorecard.io/companies/scorecard\_identifier/issues/redirect\_to\_insecure\_website \\
