Get "links\_to\_insecure\_website" issues in a scorec
=====================================================

get https://api.securityscorecard.io/companies/{scorecard\_identifier}/issues/links\_to\_insecure\_website

Get "links\_to\_insecure\_website" issues in a scorecard
...
A page in a list of LinksToInsecureWebsites
...
[Log in to use your API keys](/login?redirect_uri=/reference/get_companies-scorecard-identifier-issues-links-to-insecure-website)
...
2
     ...
     \--url https://api.securityscorecard.io/companies/scorecard\_identifier/issues/links\_to\_insecure\_website \\
