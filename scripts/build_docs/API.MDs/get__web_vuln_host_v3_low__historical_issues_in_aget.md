Get "web\_vuln\_host\_v3\_low" historical issues in a
=====================================================

get https://api.securityscorecard.io/companies/{scorecard\_identifier}/history/events/{effective\_date}/issues/web\_vuln\_host\_v3\_low/

Get "web\_vuln\_host\_v3\_low" historical issues in a scorecard
...
A page in a list of HistoricalWebVulnHostV3Lows
...
[Log in to use your API keys](/login?redirect_uri=/reference/get_companies-scorecard-identifier-history-events-effective-date-issues-web-vuln-host-v3-low)
...
2
     ...
     \--url https://api.securityscorecard.io/companies/scorecard\_identifier/history/events/effective\_date/issues/web\_vuln\_host\_v3\_low/ \\
