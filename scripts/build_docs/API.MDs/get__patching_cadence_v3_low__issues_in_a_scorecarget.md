Get "patching\_cadence\_v3\_low" issues in a scorecar
=====================================================

get https://api.securityscorecard.io/companies/{scorecard\_identifier}/issues/patching\_cadence\_v3\_low

Get "patching\_cadence\_v3\_low" issues in a scorecard
...
A page in a list of PatchingCadenceV3Lows
...
[Log in to use your API keys](/login?redirect_uri=/reference/get_companies-scorecard-identifier-issues-patching-cadence-v3-low)
...
2
     ...
     \--url https://api.securityscorecard.io/companies/scorecard\_identifier/issues/patching\_cadence\_v3\_low \\
