Get "spf\_record\_wildcard" issues in a scorecard
=================================================

get https://api.securityscorecard.io/companies/{scorecard\_identifier}/issues/spf\_record\_wildcard
...
A page in a list of SpfRecordWildcards
...
[Log in to use your API keys](/login?redirect_uri=/reference/get_companies-scorecard-identifier-issues-spf-record-wildcard-1)
...
2
     ...
     \--url https://api.securityscorecard.io/companies/scorecard\_identifier/issues/spf\_record\_wildcard \\
