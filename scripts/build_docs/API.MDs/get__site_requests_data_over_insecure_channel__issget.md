Get "site\_requests\_data\_over\_insecure\_channel" iss
=======================================================

get https://api.securityscorecard.io/companies/{scorecard\_identifier}/issues/site\_requests\_data\_over\_insecure\_channel

Get "site\_requests\_data\_over\_insecure\_channel" issues in a scorecard
...
A page in a list of SiteRequestsDataOverInsecureChannels
...
[Log in to use your API keys](/login?redirect_uri=/reference/get_companies-scorecard-identifier-issues-site-requests-data-over-insecure-channel-1)
...
2
     ...
     \--url https://api.securityscorecard.io/companies/scorecard\_identifier/issues/site\_requests\_data\_over\_insecure\_channel \\
