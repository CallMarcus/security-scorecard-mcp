Get "communication\_server\_with\_expired\_cert" issue
======================================================

get https://api.securityscorecard.io/companies/{scorecard\_identifier}/issues/communication\_server\_with\_expired\_cert

Get "communication\_server\_with\_expired\_cert" issues in a scorecard
...
A page in a list of CommunicationServerWithExpiredCerts
...
[Log in to use your API keys](/login?redirect_uri=/reference/get_companies-scorecard-identifier-issues-communication-server-with-expired-cert)
...
2
     ...
     \--url https://api.securityscorecard.io/companies/scorecard\_identifier/issues/communication\_server\_with\_expired\_cert \\
