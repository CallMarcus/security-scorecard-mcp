Get "service\_end\_of\_service" issues in a scorecard
=====================================================

get https://api.securityscorecard.io/companies/{scorecard\_identifier}/issues/service\_end\_of\_service
...
A page in a list of ServiceEndOfServices
...
[Log in to use your API keys](/login?redirect_uri=/reference/get_companies-scorecard-identifier-issues-service-end-of-service-1)
...
2
     ...
     \--url https://api.securityscorecard.io/companies/scorecard\_identifier/issues/service\_end\_of\_service \\
