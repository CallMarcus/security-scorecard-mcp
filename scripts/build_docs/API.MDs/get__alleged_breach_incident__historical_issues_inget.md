Get "alleged\_breach\_incident" historical issues in
====================================================

get https://api.securityscorecard.io/companies/{scorecard\_identifier}/history/events/{effective\_date}/issues/alleged\_breach\_incident/

Get "alleged\_breach\_incident" historical issues in a scorecard
...
A page in a list of HistoricalAllegedBreachIncidents
...
[Log in to use your API keys](/login?redirect_uri=/reference/get_companies-scorecard-identifier-history-events-effective-date-issues-alleged-breach-incident-1)
...
2
     ...
     \--url https://api.securityscorecard.io/companies/scorecard\_identifier/history/events/effective\_date/issues/alleged\_breach\_incident/ \\
