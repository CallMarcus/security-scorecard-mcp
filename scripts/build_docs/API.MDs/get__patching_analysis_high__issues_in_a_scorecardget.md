Get "patching\_analysis\_high" issues in a scorecard
====================================================

get https://api.securityscorecard.io/companies/{scorecard\_identifier}/issues/patching\_analysis\_high
...
A page in a list of PatchingAnalysisHighs
...
[Log in to use your API keys](/login?redirect_uri=/reference/get_companies-scorecard-identifier-issues-patching-analysis-high-1)
...
2
     ...
     \--url https://api.securityscorecard.io/companies/scorecard\_identifier/issues/patching\_analysis\_high \\
