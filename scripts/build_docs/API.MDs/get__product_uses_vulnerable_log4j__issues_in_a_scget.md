Get "product\_uses\_vulnerable\_log4j" issues in a sc
=====================================================

get https://api.securityscorecard.io/companies/{scorecard\_identifier}/issues/product\_uses\_vulnerable\_log4j

Get "product\_uses\_vulnerable\_log4j" issues in a scorecard
...
A page in a list of ProductUsesVulnerableLog4JS
...
[Log in to use your API keys](/login?redirect_uri=/reference/get_companies-scorecard-identifier-issues-product-uses-vulnerable-log4j-1)
...
2
     ...
     \--url https://api.securityscorecard.io/companies/scorecard\_identifier/issues/product\_uses\_vulnerable\_log4j \\
