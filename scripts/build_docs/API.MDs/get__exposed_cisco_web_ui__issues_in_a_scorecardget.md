Get "exposed\_cisco\_web\_ui" issues in a scorecard
===================================================

get https://api.securityscorecard.io/companies/{scorecard\_identifier}/issues/exposed\_cisco\_web\_ui
...
A page in a list of ExposedCiscoWebUis
...
[Log in to use your API keys](/login?redirect_uri=/reference/get_companies-scorecard-identifier-issues-exposed-cisco-web-ui)
...
2
     ...
     \--url https://api.securityscorecard.io/companies/scorecard\_identifier/issues/exposed\_cisco\_web\_ui \\
