Get "general\_scan\_detected" historical issues in a
====================================================

get https://api.securityscorecard.io/companies/{scorecard\_identifier}/history/events/{effective\_date}/issues/general\_scan\_detected/

Get "general\_scan\_detected" historical issues in a scorecard
...
A page in a list of HistoricalGeneralScanDetecteds
...
[Log in to use your API keys](/login?redirect_uri=/reference/get_companies-scorecard-identifier-history-events-effective-date-issues-general-scan-detected-1)
...
2
     ...
     \--url https://api.securityscorecard.io/companies/scorecard\_identifier/history/events/effective\_date/issues/general\_scan\_detected/ \\
