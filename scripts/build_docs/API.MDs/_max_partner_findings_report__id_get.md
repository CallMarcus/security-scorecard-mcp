/max/partner/findings/report/{id}
=================================

get https://api.securityscorecard.io/max/partner/findings/report/{id}

Gets the findings for the report having the report id
...
[Log in to use your API keys](/login?redirect_uri=/reference/get_max-partner-findings-report-id)
...
2
     ...
     \--url https://api.securityscorecard.io/max/partner/findings/report/id \\
