Get "attempted\_information\_leak" historical issues
====================================================

get https://api.securityscorecard.io/companies/{scorecard\_identifier}/history/events/{effective\_date}/issues/attempted\_information\_leak/

Get "attempted\_information\_leak" historical issues in a scorecard
...
A page in a list of HistoricalAttemptedInformationLeaks
...
[Log in to use your API keys](/login?redirect_uri=/reference/get_companies-scorecard-identifier-history-events-effective-date-issues-attempted-information-leak-1)
...
2
     ...
     \--url https://api.securityscorecard.io/companies/scorecard\_identifier/history/events/effective\_date/issues/attempted\_information\_leak/ \\
