Get "websocket\_sends\_data" historical issues in a
===================================================

get https://api.securityscorecard.io/companies/{scorecard\_identifier}/history/events/{effective\_date}/issues/websocket\_sends\_data/

Get "websocket\_sends\_data" historical issues in a scorecard
...
A page in a list of HistoricalWebsocketSendsData
...
[Log in to use your API keys](/login?redirect_uri=/reference/get_companies-scorecard-identifier-history-events-effective-date-issues-websocket-sends-data-1)
...
2
     ...
     \--url https://api.securityscorecard.io/companies/scorecard\_identifier/history/events/effective\_date/issues/websocket\_sends\_data/ \\
