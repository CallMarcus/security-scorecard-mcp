Get "ransomware\_infection\_trail" issues in a score
====================================================

get https://api.securityscorecard.io/companies/{scorecard\_identifier}/issues/ransomware\_infection\_trail

Get "ransomware\_infection\_trail" issues in a scorecard
...
[Log in to use your API keys](/login?redirect_uri=/reference/get_companies-scorecard-identifier-issues-ransomware-infection-trail-1)
...
2
     ...
     \--url https://api.securityscorecard.io/companies/scorecard\_identifier/issues/ransomware\_infection\_trail \\
