Get "adware\_installation\_trail" issues in a scorec
====================================================

get https://api.securityscorecard.io/companies/{scorecard\_identifier}/issues/adware\_installation\_trail

Get "adware\_installation\_trail" issues in a scorecard
...
A page in a list of AdwareInstallationTrails
...
[Log in to use your API keys](/login?redirect_uri=/reference/get_companies-scorecard-identifier-issues-adware-installation-trail)
...
2
     ...
     \--url https://api.securityscorecard.io/companies/scorecard\_identifier/issues/adware\_installation\_trail \\
