...
post https://api.securityscorecard.io/companies/{domain}/issues/{type}/feedback-validation-request
...
[Log in to use your API keys](/login?redirect_uri=/reference/post_companies-domain-issues-type-feedback-validation-request)
...
2
     ...
     \--url https://api.securityscorecard.io/companies/domain/issues/type/feedback-validation-request \\
