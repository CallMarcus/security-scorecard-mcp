Get "service\_end\_of\_life" issues in a scorecard
==================================================

get https://api.securityscorecard.io/companies/{scorecard\_identifier}/issues/service\_end\_of\_life
...
A page in a list of ServiceEndOfLives
...
[Log in to use your API keys](/login?redirect_uri=/reference/get_companies-scorecard-identifier-issues-service-end-of-life-1)
...
2
     ...
     \--url https://api.securityscorecard.io/companies/scorecard\_identifier/issues/service\_end\_of\_life \\
