Get "potentially\_vulnerable\_cve\_2023\_34362" issues
======================================================

get https://api.securityscorecard.io/companies/{scorecard\_identifier}/issues/potentially\_vulnerable\_cve\_2023\_34362

Get "potentially\_vulnerable\_cve\_2023\_34362" issues in a scorecard
...
A page in a list of PotentiallyVulnerableCve202334362s
...
[Log in to use your API keys](/login?redirect_uri=/reference/get_companies-scorecard-identifier-issues-potentially-vulnerable-cve-2023-34362)
...
2
     ...
     \--url https://api.securityscorecard.io/companies/scorecard\_identifier/issues/potentially\_vulnerable\_cve\_2023\_34362 \\
