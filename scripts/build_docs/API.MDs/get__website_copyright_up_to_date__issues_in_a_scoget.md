Get "website\_copyright\_up\_to\_date" issues in a sco
======================================================

get https://api.securityscorecard.io/companies/{scorecard\_identifier}/issues/website\_copyright\_up\_to\_date

Get "website\_copyright\_up\_to\_date" issues in a scorecard
...
A page in a list of WebsiteCopyrightUpToDates
...
[Log in to use your API keys](/login?redirect_uri=/reference/get_companies-scorecard-identifier-issues-website-copyright-up-to-date-1)
...
2
     ...
     \--url https://api.securityscorecard.io/companies/scorecard\_identifier/issues/website\_copyright\_up\_to\_date \\
