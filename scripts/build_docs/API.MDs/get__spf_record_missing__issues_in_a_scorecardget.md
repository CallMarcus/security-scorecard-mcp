Get "spf\_record\_missing" issues in a scorecard
================================================

get https://api.securityscorecard.io/companies/{scorecard\_identifier}/issues/spf\_record\_missing
...
A page in a list of SpfRecordMissings
...
[Log in to use your API keys](/login?redirect_uri=/reference/get_companies-scorecard-identifier-issues-spf-record-missing-1)
...
2
     ...
     \--url https://api.securityscorecard.io/companies/scorecard\_identifier/issues/spf\_record\_missing \\
