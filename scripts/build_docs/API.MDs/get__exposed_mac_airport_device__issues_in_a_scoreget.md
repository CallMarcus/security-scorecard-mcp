Get "exposed\_mac\_airport\_device" issues in a score
=====================================================

get https://api.securityscorecard.io/companies/{scorecard\_identifier}/issues/exposed\_mac\_airport\_device

Get "exposed\_mac\_airport\_device" issues in a scorecard
...
A page in a list of ExposedMacAirportDevices
...
[Log in to use your API keys](/login?redirect_uri=/reference/get_companies-scorecard-identifier-issues-exposed-mac-airport-device)
...
2
     ...
     \--url https://api.securityscorecard.io/companies/scorecard\_identifier/issues/exposed\_mac\_airport\_device \\
