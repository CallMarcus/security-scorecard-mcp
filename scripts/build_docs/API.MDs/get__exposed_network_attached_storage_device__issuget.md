Get "exposed\_network\_attached\_storage\_device" issu
======================================================

get https://api.securityscorecard.io/companies/{scorecard\_identifier}/issues/exposed\_network\_attached\_storage\_device

Get "exposed\_network\_attached\_storage\_device" issues in a scorecard
...
A page in a list of ExposedNetworkAttachedStorageDevices
...
[Log in to use your API keys](/login?redirect_uri=/reference/get_companies-scorecard-identifier-issues-exposed-network-attached-storage-device)
...
2
     ...
     \--url https://api.securityscorecard.io/companies/scorecard\_identifier/issues/exposed\_network\_attached\_storage\_device \\
