/max/customer/findings
======================

get https://api.securityscorecard.io/max/customer/findings

Gets triaged and reported findings of current customer
...
Default is false and retrieves 15 days findings, if allDates is true will return 30 days findings
...
True for findings related with a known exploited CVE
...
[Log in to use your API keys](/login?redirect_uri=/reference/get_max-customer-findings)
...
2
     ...
     \--url https://api.securityscorecard.io/max/customer/findings \\
