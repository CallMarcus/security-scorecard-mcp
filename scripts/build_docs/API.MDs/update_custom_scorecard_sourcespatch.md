...
patch https://api.securityscorecard.io/custom-scorecards/{id}/sources
...
id of custom scorecard to add sources
...
Sources list. Maximum 20 sources
...
[Log in to use your API keys](/login?redirect_uri=/reference/patch_custom-scorecards-id-sources)
...
2
     ...
     \--url https://api.securityscorecard.io/custom-scorecards/id/sources \\
