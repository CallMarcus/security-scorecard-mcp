Get "service\_vuln\_host\_medium" issues in a scoreca
=====================================================

get https://api.securityscorecard.io/companies/{scorecard\_identifier}/issues/service\_vuln\_host\_medium

Get "service\_vuln\_host\_medium" issues in a scorecard
...
A page in a list of ServiceVulnHostMediums
...
[Log in to use your API keys](/login?redirect_uri=/reference/get_companies-scorecard-identifier-issues-service-vuln-host-medium-1)
...
2
     ...
     \--url https://api.securityscorecard.io/companies/scorecard\_identifier/issues/service\_vuln\_host\_medium \\
