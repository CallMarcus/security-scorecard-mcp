Get "adware\_installation" historical issues in a s
===================================================

get https://api.securityscorecard.io/companies/{scorecard\_identifier}/history/events/{effective\_date}/issues/adware\_installation/

Get "adware\_installation" historical issues in a scorecard
...
A page in a list of HistoricalAdwareInstallations
...
[Log in to use your API keys](/login?redirect_uri=/reference/get_companies-scorecard-identifier-history-events-effective-date-issues-adware-installation-1)
...
2
     ...
     \--url https://api.securityscorecard.io/companies/scorecard\_identifier/history/events/effective\_date/issues/adware\_installation/ \\
