...
- **operationId:** `get_companies-scorecard-identifier-history-events-effective-date-issues-sensitive-data-exposure-through-insecure-channel`
...
```bash
curl -X GET \
  'https://api.securityscorecard.io//companies/<scorecard_identifier>/history/events/<effective_date>/issues/sensitive_data_exposure_through_insecure_channel/' \
