# Get "alleged_first_party_breach" historical issues

- **Method:** `GET`
- **Path:** `/companies/{scorecard_identifier}/history/events/{effective_date}/issues/alleged_first_party_breach/`
- **Tag:** `historical findings`
- **operationId:** `get_companies-scorecard-identifier-history-events-effective-date-issues-alleged-first-party-breach`

## Description
Get "alleged_first_party_breach" historical issues in a scorecard
...
## Responses
### 200
A page in a list of HistoricalAllegedFirstPartyBreaches
```json
{
  "type": "object",
  "properties": {
    "entries": {
      ...
      "items": {
        ...
        "additionalProperties": false,
        "description": "\"alleged_first_party_breach\" historical issues in a scorecard"
      }
    }
  },
  "additionalProperties": false,
  ...
  "description": "A page in a list of HistoricalAllegedFirstPartyBreaches"
}
```
...
```bash
curl -X GET \
  'https://api.securityscorecard.io//companies/<scorecard_identifier>/history/events/<effective_date>/issues/alleged_first_party_breach/' \
