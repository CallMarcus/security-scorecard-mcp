# Get "confirmed_first_party_breach" historical issu

- **Method:** `GET`
- **Path:** `/companies/{scorecard_identifier}/history/events/{effective_date}/issues/confirmed_first_party_breach/`
- **Tag:** `historical findings`
- **operationId:** `get_companies-scorecard-identifier-history-events-effective-date-issues-confirmed-first-party-breach`

## Description
Get "confirmed_first_party_breach" historical issues in a scorecard
...
## Responses
### 200
A page in a list of HistoricalConfirmedFirstPartyBreaches
```json
{
  "type": "object",
  "properties": {
    "entries": {
      ...
      "items": {
        ...
        "additionalProperties": false,
        "description": "\"confirmed_first_party_breach\" historical issues in a scorecard"
      }
    }
  },
  "additionalProperties": false,
  ...
  "description": "A page in a list of HistoricalConfirmedFirstPartyBreaches"
}
```
...
```bash
curl -X GET \
  'https://api.securityscorecard.io//companies/<scorecard_identifier>/history/events/<effective_date>/issues/confirmed_first_party_breach/' \
