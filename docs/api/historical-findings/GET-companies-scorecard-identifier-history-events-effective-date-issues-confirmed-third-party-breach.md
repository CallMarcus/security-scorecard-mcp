# Get "confirmed_third_party_breach" historical issu

- **Method:** `GET`
- **Path:** `/companies/{scorecard_identifier}/history/events/{effective_date}/issues/confirmed_third_party_breach/`
- **Tag:** `historical findings`
- **operationId:** `get_companies-scorecard-identifier-history-events-effective-date-issues-confirmed-third-party-breach`

## Description
Get "confirmed_third_party_breach" historical issues in a scorecard
...
## Responses
### 200
A page in a list of HistoricalConfirmedThirdPartyBreaches
```json
{
  "type": "object",
  "properties": {
    "entries": {
      ...
      "items": {
        ...
        "additionalProperties": false,
        "description": "\"confirmed_third_party_breach\" historical issues in a scorecard"
      }
    }
  },
  "additionalProperties": false,
  ...
  "description": "A page in a list of HistoricalConfirmedThirdPartyBreaches"
}
```
...
```bash
curl -X GET \
  'https://api.securityscorecard.io//companies/<scorecard_identifier>/history/events/<effective_date>/issues/confirmed_third_party_breach/' \
