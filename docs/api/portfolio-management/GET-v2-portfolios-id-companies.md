...
- **Operation ID:** `get_v2-portfolios-id-companies`
...
- `with_factors` (boolean, Optional) - return factors, along with portfolio companies
...
```bash
curl -X GET \
  'https://platform.securityscorecard.io/v2/portfolios/<id>/companies' \
