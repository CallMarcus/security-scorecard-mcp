...
- **Method:** `PUT`
- **Path:** `/v1/organizations/{id}/profile`
- **Tag:** `Organization`
- **operationId:** `put_v1-organizations-id-profile`
...
```json
{
  ...
  "properties": {
      ...
      "properties": {
        "value": {
          ...
          "properties": {
            "exists": {
              "type": "boolean",
              "description": "true if ciso exists for the company"
            },
            "first_name": {
              "type": "string",
    ...
    "security_grades": {
      ...
      "properties": {
        "value": {
          "description": "company security grades",
          "type": "object",
          "properties": {
            "filters": {
              "type": "object",
    ...
    "trusted_by": {
      ...
      "properties": {
        "value": {
          ...
          "description": "list of trusted by"
        }
      },
      "additionalProperties": false,
      "required": [
      ...
      "properties": {
        "value": {
          ...
          "properties": {
            "exists": {
              "type": "boolean",
              "description": "true if company has two factor authentication"
            }
          },
          "additionalProperties": false,
          "required": [
        ...
        "value": {
          ...
          "properties": {
            "comment": {
              "type": "string",
              "maxLength": 1500,
              "description": "text description of Multi-Factor Authentication enforcment in organization"
            },
            "status": {
              "type": "string",
              "description": "Enforcement policy in organization, one of: advised, enforced, not_enforced"
            }
          },
          "additionalProperties": false,
          "required": [
...
```bash
curl -X PUT \
  'https://api.securityscorecard.io//v1/organizations/<id>/profile' \
