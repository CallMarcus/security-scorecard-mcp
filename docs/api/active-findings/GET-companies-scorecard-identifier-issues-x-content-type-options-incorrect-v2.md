...
- **Tag:** `active findings`
- **operationId:** `get_companies-scorecard-identifier-issues-x-content-type-options-incorrect-v2`
...
```bash
curl -X GET \
  'https://api.securityscorecard.io//companies/<scorecard_identifier>/issues/x_content_type_options_incorrect_v2' \
