...
- **Tag:** `active findings`
- **operationId:** `get_companies-scorecard-identifier-issues-synth-high-risk-appsec-vulnerabilities`
...
```bash
curl -X GET \
  'https://api.securityscorecard.io//companies/<scorecard_identifier>/issues/synth_high_risk_appsec_vulnerabilities' \
