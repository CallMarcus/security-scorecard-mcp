...
- **Tag:** `active findings`
- **operationId:** `get_companies-scorecard-identifier-issues-exposed-personal-information-info`
...
```bash
curl -X GET \
  'https://api.securityscorecard.io//companies/<scorecard_identifier>/issues/exposed_personal_information_info' \
