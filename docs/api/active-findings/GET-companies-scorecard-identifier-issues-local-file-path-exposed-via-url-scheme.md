...
- **Tag:** `active findings`
- **operationId:** `get_companies-scorecard-identifier-issues-local-file-path-exposed-via-url-scheme`
...
```bash
curl -X GET \
  'https://api.securityscorecard.io//companies/<scorecard_identifier>/issues/local_file_path_exposed_via_url_scheme' \
