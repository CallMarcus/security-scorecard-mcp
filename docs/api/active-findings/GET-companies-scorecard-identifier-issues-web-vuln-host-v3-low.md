...
- **Method:** `GET`
- **Path:** `/companies/{scorecard_identifier}/issues/web_vuln_host_v3_low`
- **Tag:** `active findings`
- **operationId:** `get_companies-scorecard-identifier-issues-web-vuln-host-v3-low`
...
```json
{
  ...
  "properties": {
    "entries": {
      ...
      "items": {
        ...
        "description": "\"web_vuln_host_v3_low\" issues in a scorecard"
      }
    }
  },
  "additionalProperties": false,
  ...
  "description": "A page in a list of WebVulnHostV3Lows"
}
```
...
```bash
curl -X GET \
  'https://api.securityscorecard.io//companies/<scorecard_identifier>/issues/web_vuln_host_v3_low' \
