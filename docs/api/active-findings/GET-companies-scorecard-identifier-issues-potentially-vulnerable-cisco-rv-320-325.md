...
- **Tag:** `active findings`
- **operationId:** `get_companies-scorecard-identifier-issues-potentially-vulnerable-cisco-rv-320-325`
...
```bash
curl -X GET \
  'https://api.securityscorecard.io//companies/<scorecard_identifier>/issues/potentially_vulnerable_cisco_rv_320_325' \
