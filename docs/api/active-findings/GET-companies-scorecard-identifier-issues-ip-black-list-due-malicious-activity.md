...
- **Tag:** `active findings`
- **operationId:** `get_companies-scorecard-identifier-issues-ip-black-list-due-malicious-activity`
...
```bash
curl -X GET \
  'https://api.securityscorecard.io//companies/<scorecard_identifier>/issues/ip_black_list_due_malicious_activity' \
