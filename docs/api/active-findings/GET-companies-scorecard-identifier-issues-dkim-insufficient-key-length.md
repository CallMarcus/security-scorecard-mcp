...
- **Tag:** `active findings`
- **operationId:** `get_companies-scorecard-identifier-issues-dkim-insufficient-key-length`
...
```bash
curl -X GET \
  'https://api.securityscorecard.io//companies/<scorecard_identifier>/issues/dkim_insufficient_key_length' \
