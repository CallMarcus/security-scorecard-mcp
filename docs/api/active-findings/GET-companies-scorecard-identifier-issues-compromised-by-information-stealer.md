...
- **Tag:** `active findings`
- **operationId:** `get_companies-scorecard-identifier-issues-compromised-by-information-stealer`
...
```bash
curl -X GET \
  'https://api.securityscorecard.io//companies/<scorecard_identifier>/issues/compromised_by_information_stealer' \
