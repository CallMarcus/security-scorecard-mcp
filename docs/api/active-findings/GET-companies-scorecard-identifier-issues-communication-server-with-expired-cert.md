...
- **Tag:** `active findings`
- **operationId:** `get_companies-scorecard-identifier-issues-communication-server-with-expired-cert`
...
```bash
curl -X GET \
  'https://api.securityscorecard.io//companies/<scorecard_identifier>/issues/communication_server_with_expired_cert' \
