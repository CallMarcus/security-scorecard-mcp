...
- **Tag:** `active findings`
- **operationId:** `get_companies-scorecard-identifier-issues-known-compromised-or-hostile-host`
...
```bash
curl -X GET \
  'https://api.securityscorecard.io//companies/<scorecard_identifier>/issues/known_compromised_or_hostile_host' \
