...
- **Tag:** `active findings`
- **operationId:** `get_companies-scorecard-identifier-issues-product-uses-vulnerable-log4j`
...
```bash
curl -X GET \
  'https://api.securityscorecard.io//companies/<scorecard_identifier>/issues/product_uses_vulnerable_log4j' \
