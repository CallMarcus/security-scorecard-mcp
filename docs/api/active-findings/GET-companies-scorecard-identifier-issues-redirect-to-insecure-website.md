...
- **Tag:** `active findings`
- **operationId:** `get_companies-scorecard-identifier-issues-redirect-to-insecure-website`
...
```bash
curl -X GET \
  'https://api.securityscorecard.io//companies/<scorecard_identifier>/issues/redirect_to_insecure_website' \
