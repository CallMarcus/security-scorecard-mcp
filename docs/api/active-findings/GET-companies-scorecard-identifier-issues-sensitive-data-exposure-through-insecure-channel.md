...
- **Tag:** `active findings`
- **operationId:** `get_companies-scorecard-identifier-issues-sensitive-data-exposure-through-insecure-channel`
...
```bash
curl -X GET \
  'https://api.securityscorecard.io//companies/<scorecard_identifier>/issues/sensitive_data_exposure_through_insecure_channel' \
