...
- **Tag:** `active findings`
- **operationId:** `get_companies-scorecard-identifier-issues-cookie-missing-secure-attribute`
...
```bash
curl -X GET \
  'https://api.securityscorecard.io//companies/<scorecard_identifier>/issues/cookie_missing_secure_attribute' \
