...
- **Tag:** `active findings`
- **operationId:** `get_companies-scorecard-identifier-issues-xss-payload-using-tor-proxy-detected`
...
```bash
curl -X GET \
  'https://api.securityscorecard.io//companies/<scorecard_identifier>/issues/xss_payload_using_tor_proxy_detected' \
