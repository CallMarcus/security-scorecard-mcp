...
- **Tag:** `active findings`
- **operationId:** `get_companies-scorecard-identifier-issues-synth-possible-initial-access`
...
```bash
curl -X GET \
  'https://api.securityscorecard.io//companies/<scorecard_identifier>/issues/synth_possible_initial_access' \
