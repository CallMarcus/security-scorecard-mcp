...
- **Tag:** `active findings`
- **operationId:** `get_companies-scorecard-identifier-issues-threat-actor-hosting-infrastructure`
...
```bash
curl -X GET \
  'https://api.securityscorecard.io//companies/<scorecard_identifier>/issues/threat_actor_hosting_infrastructure' \
