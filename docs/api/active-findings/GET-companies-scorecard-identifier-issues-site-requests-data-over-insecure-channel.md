...
- **Tag:** `active findings`
- **operationId:** `get_companies-scorecard-identifier-issues-site-requests-data-over-insecure-channel`
...
```bash
curl -X GET \
  'https://api.securityscorecard.io//companies/<scorecard_identifier>/issues/site_requests_data_over_insecure_channel' \
