...
- **Tag:** `active findings`
- **operationId:** `get_companies-scorecard-identifier-issues-websocket-requests-contain-sensitive-fields`
...
```bash
curl -X GET \
  'https://api.securityscorecard.io//companies/<scorecard_identifier>/issues/websocket_requests_contain_sensitive_fields' \
