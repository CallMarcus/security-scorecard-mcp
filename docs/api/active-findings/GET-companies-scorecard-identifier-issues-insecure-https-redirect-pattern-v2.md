...
- **Tag:** `active findings`
- **operationId:** `get_companies-scorecard-identifier-issues-insecure-https-redirect-pattern-v2`
...
```bash
curl -X GET \
  'https://api.securityscorecard.io//companies/<scorecard_identifier>/issues/insecure_https_redirect_pattern_v2' \
