...
- **Tag:** `active findings`
- **operationId:** `get_companies-scorecard-identifier-issues-exposed-embedded-iot-web-server`
...
```bash
curl -X GET \
  'https://api.securityscorecard.io//companies/<scorecard_identifier>/issues/exposed_embedded_iot_web_server' \
