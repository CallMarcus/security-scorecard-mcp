...
- **Tag:** `active findings`
- **operationId:** `get_companies-scorecard-identifier-issues-redirect-chain-contains-http-v2`
...
```bash
curl -X GET \
  'https://api.securityscorecard.io//companies/<scorecard_identifier>/issues/redirect_chain_contains_http_v2' \
