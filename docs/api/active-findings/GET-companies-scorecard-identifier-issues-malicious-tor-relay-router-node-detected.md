...
- **Tag:** `active findings`
- **operationId:** `get_companies-scorecard-identifier-issues-malicious-tor-relay-router-node-detected`
...
```bash
curl -X GET \
  'https://api.securityscorecard.io//companies/<scorecard_identifier>/issues/malicious_tor_relay_router_node_detected' \
