...
- **Tag:** `active findings`
- **operationId:** `get_companies-scorecard-identifier-issues-browser-logs-contain-debug-message`
...
```bash
curl -X GET \
  'https://api.securityscorecard.io//companies/<scorecard_identifier>/issues/browser_logs_contain_debug_message' \
