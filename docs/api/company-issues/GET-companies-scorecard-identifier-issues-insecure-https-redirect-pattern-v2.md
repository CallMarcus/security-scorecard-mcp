# Get "insecure_https_redirect_pattern_v2" issues in

- **Method:** `GET`
- **Path:** `/companies/{scorecard_identifier}/issues/insecure_https_redirect_pattern_v2`
- **Category:** `company-issues`
- **Operation ID:** `get_companies-scorecard-identifier-issues-insecure-https-redirect-pattern-v2`
...
```json
{
  ...
  "properties": {
    "entries": {
      ...
      "items": {
        ...
        "description": "\"insecure_https_redirect_pattern_v2\" issues in a scorecard"
      }
    }
  },
  "additionalProperties": false,
  ...
  "description": "A page in a list of InsecureHttpsRedirectPatternV2s"
}
```
...
```bash
curl -X GET \
  'https://platform.securityscorecard.io/companies/<scorecard_identifier>/issues/insecure_https_redirect_pattern_v2' \
