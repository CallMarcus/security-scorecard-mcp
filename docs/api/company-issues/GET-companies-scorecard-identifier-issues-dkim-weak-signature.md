...
- **Operation ID:** `get_companies-scorecard-identifier-issues-dkim-weak-signature`
...
```bash
curl -X GET \
  'https://platform.securityscorecard.io/companies/<scorecard_identifier>/issues/dkim_weak_signature' \
