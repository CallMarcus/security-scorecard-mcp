...
- **Method:** `GET`
- **Path:** `/companies/{scorecard_identifier}/issues/tlscert_revoked`
- **Category:** `company-issues`
- **Operation ID:** `get_companies-scorecard-identifier-issues-tlscert-revoked`
...
```json
{
  ...
  "properties": {
    "entries": {
      ...
      "items": {
        ...
        "description": "\"tlscert_revoked\" issues in a scorecard"
      }
    }
  },
  "additionalProperties": false,
  ...
  "description": "A page in a list of TlscertRevokeds"
}
```
...
```bash
curl -X GET \
  'https://platform.securityscorecard.io/companies/<scorecard_identifier>/issues/tlscert_revoked' \
