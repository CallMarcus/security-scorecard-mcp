...
- **Method:** `GET`
- **Path:** `/companies/{scorecard_identifier}/issues/service_end_of_service`
- **Category:** `company-issues`
- **Operation ID:** `get_companies-scorecard-identifier-issues-service-end-of-service`
...
```json
{
  ...
  "properties": {
    "entries": {
      ...
      "items": {
        ...
        "description": "\"service_end_of_service\" issues in a scorecard"
      }
    }
  },
  "additionalProperties": false,
  ...
  "description": "A page in a list of ServiceEndOfServices"
}
```
...
```bash
curl -X GET \
  'https://platform.securityscorecard.io/companies/<scorecard_identifier>/issues/service_end_of_service' \
