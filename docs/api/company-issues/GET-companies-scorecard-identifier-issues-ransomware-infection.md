...
- **Method:** `GET`
- **Path:** `/companies/{scorecard_identifier}/issues/ransomware_infection`
- **Category:** `company-issues`
- **Operation ID:** `get_companies-scorecard-identifier-issues-ransomware-infection`
...
### 200
A page in a list of RansomwareInfections
```json
{
  "type": "object",
  "properties": {
    "entries": {
      ...
      "items": {
        ...
        "description": "\"ransomware_infection\" issues in a scorecard"
      }
    }
  },
  "additionalProperties": false,
  ...
  "description": "A page in a list of RansomwareInfections"
}
```
...
```bash
curl -X GET \
  'https://platform.securityscorecard.io/companies/<scorecard_identifier>/issues/ransomware_infection' \
