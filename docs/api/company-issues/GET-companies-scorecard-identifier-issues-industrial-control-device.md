# Get "industrial_control_device" issues in a scorec

- **Method:** `GET`
- **Path:** `/companies/{scorecard_identifier}/issues/industrial_control_device`
- **Category:** `company-issues`
- **Operation ID:** `get_companies-scorecard-identifier-issues-industrial-control-device`
...
```json
{
  ...
  "properties": {
    "entries": {
      ...
      "items": {
        ...
        "description": "\"industrial_control_device\" issues in a scorecard"
      }
    }
  },
  "additionalProperties": false,
  ...
  "description": "A page in a list of IndustrialControlDevices"
}
```
...
```bash
curl -X GET \
  'https://platform.securityscorecard.io/companies/<scorecard_identifier>/issues/industrial_control_device' \
