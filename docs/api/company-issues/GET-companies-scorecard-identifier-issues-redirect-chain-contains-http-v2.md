# Get "redirect_chain_contains_http_v2" issues in a 

- **Method:** `GET`
- **Path:** `/companies/{scorecard_identifier}/issues/redirect_chain_contains_http_v2`
- **Category:** `company-issues`
- **Operation ID:** `get_companies-scorecard-identifier-issues-redirect-chain-contains-http-v2`
...
```json
{
  ...
  "properties": {
    "entries": {
      ...
      "items": {
        ...
        "description": "\"redirect_chain_contains_http_v2\" issues in a scorecard"
      }
    }
  },
  "additionalProperties": false,
  ...
  "description": "A page in a list of RedirectChainContainsHttpV2s"
}
```
...
```bash
curl -X GET \
  'https://platform.securityscorecard.io/companies/<scorecard_identifier>/issues/redirect_chain_contains_http_v2' \
