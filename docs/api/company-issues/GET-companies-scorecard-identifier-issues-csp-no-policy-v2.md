...
- **Operation ID:** `get_companies-scorecard-identifier-issues-csp-no-policy-v2`
...
```bash
curl -X GET \
  'https://platform.securityscorecard.io/companies/<scorecard_identifier>/issues/csp_no_policy_v2' \
