# Get "dkim_insufficient_key_length" historical issu

- **Method:** `GET`
- **Path:** `/companies/{scorecard_identifier}/history/events/{effective_date}/issues/dkim_insufficient_key_length/`
- **Category:** `company-issues`
- **Operation ID:** `get_companies-scorecard-identifier-history-events-effective-date-issues-dkim-insufficient-key-length`

## Description

Get "dkim_insufficient_key_length" historical issues in a scorecard
...
### 200
A page in a list of HistoricalDkimInsufficientKeyLengths
```json
{
  "type": "object",
  "properties": {
    "entries": {
      ...
      "items": {
        ...
        "additionalProperties": false,
        "description": "\"dkim_insufficient_key_length\" historical issues in a scorecard"
      }
    }
  },
  "additionalProperties": false,
  ...
  "description": "A page in a list of HistoricalDkimInsufficientKeyLengths"
}
```
...
```bash
curl -X GET \
  'https://platform.securityscorecard.io/companies/<scorecard_identifier>/history/events/<effective_date>/issues/dkim_insufficient_key_length/' \
