...
- **Method:** `GET`
- **Path:** `/companies/{scorecard_identifier}/issues/pva_installation`
- **Category:** `company-issues`
- **Operation ID:** `get_companies-scorecard-identifier-issues-pva-installation`
...
### 200
A page in a list of PvaInstallations
```json
{
  "type": "object",
  "properties": {
    "entries": {
      ...
      "items": {
        ...
        "description": "\"pva_installation\" issues in a scorecard"
      }
    }
  },
  "additionalProperties": false,
  ...
  "description": "A page in a list of PvaInstallations"
}
```
...
```bash
curl -X GET \
  'https://platform.securityscorecard.io/companies/<scorecard_identifier>/issues/pva_installation' \
