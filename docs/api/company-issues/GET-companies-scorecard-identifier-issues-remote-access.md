...
- **Method:** `GET`
- **Path:** `/companies/{scorecard_identifier}/issues/remote_access`
- **Category:** `company-issues`
- **Operation ID:** `get_companies-scorecard-identifier-issues-remote-access`
...
```json
{
  ...
  "properties": {
    "entries": {
      ...
      "items": {
        ...
        "description": "\"remote_access\" issues in a scorecard"
      }
    }
  },
  "additionalProperties": false,
  ...
  "description": "A page in a list of RemoteAccesses"
}
```
...
```bash
curl -X GET \
  'https://platform.securityscorecard.io/companies/<scorecard_identifier>/issues/remote_access' \
