# Get "redirect_to_insecure_website" issues in a sco

- **Method:** `GET`
- **Path:** `/companies/{scorecard_identifier}/issues/redirect_to_insecure_website`
- **Category:** `company-issues`
- **Operation ID:** `get_companies-scorecard-identifier-issues-redirect-to-insecure-website`
...
```json
{
  ...
  "properties": {
    "entries": {
      ...
      "items": {
        ...
        "description": "\"redirect_to_insecure_website\" issues in a scorecard"
      }
    }
  },
  "additionalProperties": false,
  ...
  "description": "A page in a list of RedirectToInsecureWebsites"
}
```
...
```bash
curl -X GET \
  'https://platform.securityscorecard.io/companies/<scorecard_identifier>/issues/redirect_to_insecure_website' \
