# Get "leaked_credentials_info" issues in a scorecar

- **Method:** `GET`
- **Path:** `/companies/{scorecard_identifier}/issues/leaked_credentials_info`
- **Category:** `company-issues`
- **Operation ID:** `get_companies-scorecard-identifier-issues-leaked-credentials-info`
...
```json
{
  ...
  "properties": {
    "entries": {
      ...
      "items": {
        ...
        "description": "\"leaked_credentials_info\" issues in a scorecard"
      }
    }
  },
  "additionalProperties": false,
  ...
  "description": "A page in a list of LeakedCredentialsInfos"
}
```
...
```bash
curl -X GET \
  'https://platform.securityscorecard.io/companies/<scorecard_identifier>/issues/leaked_credentials_info' \
