...
- **Method:** `GET`
- **Path:** `/companies/{scorecard_identifier}/issues/attack_detected`
- **Category:** `company-issues`
- **Operation ID:** `get_companies-scorecard-identifier-issues-attack-detected`
...
### 200
A page in a list of AttackDetecteds
```json
{
  "type": "object",
  "properties": {
    "entries": {
      ...
      "items": {
        ...
        "description": "\"attack_detected\" issues in a scorecard"
      }
    }
  },
  "additionalProperties": false,
  ...
  "description": "A page in a list of AttackDetecteds"
}
```
...
```bash
curl -X GET \
  'https://platform.securityscorecard.io/companies/<scorecard_identifier>/issues/attack_detected' \
