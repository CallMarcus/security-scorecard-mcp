...
- **Method:** `GET`
- **Path:** `/companies/{scorecard_identifier}/issues/web_vuln_host_high`
- **Category:** `company-issues`
- **Operation ID:** `get_companies-scorecard-identifier-issues-web-vuln-host-high`
...
```json
{
  ...
  "properties": {
    "entries": {
      ...
      "items": {
        ...
        "description": "\"web_vuln_host_high\" issues in a scorecard"
      }
    }
  },
  "additionalProperties": false,
  ...
  "description": "A page in a list of WebVulnHostHighs"
}
```
...
```bash
curl -X GET \
  'https://platform.securityscorecard.io/companies/<scorecard_identifier>/issues/web_vuln_host_high' \
