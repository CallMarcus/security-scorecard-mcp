...
- **Method:** `GET`
- **Path:** `/companies/{scorecard_identifier}/issues/service_open_vpn`
- **Category:** `company-issues`
- **Operation ID:** `get_companies-scorecard-identifier-issues-service-open-vpn`
...
```json
{
  ...
  "properties": {
    "entries": {
      ...
      "items": {
        ...
        "description": "\"service_open_vpn\" issues in a scorecard"
      }
    }
  },
  "additionalProperties": false,
  ...
  "description": "A page in a list of ServiceOpenVpns"
}
```
...
```bash
curl -X GET \
  'https://platform.securityscorecard.io/companies/<scorecard_identifier>/issues/service_open_vpn' \
