...
- **Method:** `GET`
- **Path:** `/companies/{scorecard_identifier}/issues/spf_record_missing`
- **Category:** `company-issues`
- **Operation ID:** `get_companies-scorecard-identifier-issues-spf-record-missing`
...
```json
{
  ...
  "properties": {
    "entries": {
      ...
      "items": {
        ...
        "description": "\"spf_record_missing\" issues in a scorecard"
      }
    }
  },
  "additionalProperties": false,
  ...
  "description": "A page in a list of SpfRecordMissings"
}
```
...
```bash
curl -X GET \
  'https://platform.securityscorecard.io/companies/<scorecard_identifier>/issues/spf_record_missing' \
