...
- **Method:** `GET`
- **Path:** `/companies/{scorecard_identifier}/issues/patching_analysis_high`
- **Category:** `company-issues`
- **Operation ID:** `get_companies-scorecard-identifier-issues-patching-analysis-high`
...
```json
{
  ...
  "properties": {
    "entries": {
      ...
      "items": {
        ...
        "description": "\"patching_analysis_high\" issues in a scorecard"
      }
    }
  },
  "additionalProperties": false,
  ...
  "description": "A page in a list of PatchingAnalysisHighs"
}
```
...
```bash
curl -X GET \
  'https://platform.securityscorecard.io/companies/<scorecard_identifier>/issues/patching_analysis_high' \
