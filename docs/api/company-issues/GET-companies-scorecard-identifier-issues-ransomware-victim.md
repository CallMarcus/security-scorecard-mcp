...
- **Method:** `GET`
- **Path:** `/companies/{scorecard_identifier}/issues/ransomware_victim`
- **Category:** `company-issues`
- **Operation ID:** `get_companies-scorecard-identifier-issues-ransomware-victim`
...
```json
{
  ...
  "properties": {
    "entries": {
      ...
      "items": {
        ...
        "description": "\"ransomware_victim\" issues in a scorecard"
      }
    }
  },
  "additionalProperties": false,
  ...
  "description": "A page in a list of RansomwareVictims"
}
```
...
```bash
curl -X GET \
  'https://platform.securityscorecard.io/companies/<scorecard_identifier>/issues/ransomware_victim' \
