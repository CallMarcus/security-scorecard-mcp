...
- **Method:** `GET`
- **Path:** `/companies/{scorecard_identifier}/issues/cdn_hosting`
- **Category:** `company-issues`
- **Operation ID:** `get_companies-scorecard-identifier-issues-cdn-hosting`
...
```json
{
  ...
  "properties": {
    "entries": {
      ...
      "items": {
        ...
        "description": "\"cdn_hosting\" issues in a scorecard"
      }
    }
  },
  "additionalProperties": false,
  ...
  "description": "A page in a list of CdnHostings"
}
```
...
```bash
curl -X GET \
  'https://platform.securityscorecard.io/companies/<scorecard_identifier>/issues/cdn_hosting' \
