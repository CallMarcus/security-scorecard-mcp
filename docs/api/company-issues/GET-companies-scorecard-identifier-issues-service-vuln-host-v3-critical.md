# Get "service_vuln_host_v3_critical" issues in a sc

- **Method:** `GET`
- **Path:** `/companies/{scorecard_identifier}/issues/service_vuln_host_v3_critical`
- **Category:** `company-issues`
- **Operation ID:** `get_companies-scorecard-identifier-issues-service-vuln-host-v3-critical`
...
```json
{
  ...
  "properties": {
    "entries": {
      ...
      "items": {
        ...
        "description": "\"service_vuln_host_v3_critical\" issues in a scorecard"
      }
    }
  },
  "additionalProperties": false,
  ...
  "description": "A page in a list of ServiceVulnHostV3Criticals"
}
```
...
```bash
curl -X GET \
  'https://platform.securityscorecard.io/companies/<scorecard_identifier>/issues/service_vuln_host_v3_critical' \
