...
- **Method:** `GET`
- **Path:** `/companies/{scorecard_identifier}/issues/service_oracle_db`
- **Category:** `company-issues`
- **Operation ID:** `get_companies-scorecard-identifier-issues-service-oracle-db`
...
```json
{
  ...
  "properties": {
    "entries": {
      ...
      "items": {
        ...
        "description": "\"service_oracle_db\" issues in a scorecard"
      }
    }
  },
  "additionalProperties": false,
  ...
  "description": "A page in a list of ServiceOracleDbs"
}
```
...
```bash
curl -X GET \
  'https://platform.securityscorecard.io/companies/<scorecard_identifier>/issues/service_oracle_db' \
