# Get "cookie_missing_secure_attribute" historical i

- **Method:** `GET`
- **Path:** `/companies/{scorecard_identifier}/history/events/{effective_date}/issues/cookie_missing_secure_attribute/`
- **Category:** `company-issues`
- **Operation ID:** `get_companies-scorecard-identifier-history-events-effective-date-issues-cookie-missing-secure-attribute`
...
### 200
A page in a list of HistoricalCookieMissingSecureAttributes
```json
{
  "type": "object",
  "properties": {
    "entries": {
      ...
      "items": {
        ...
        "properties": {
          ...
          "hostname": {
            "type": "string",
            "description": "Full hostname where measurement was observed."
          },
          "url": {
            "type": "string",
            "description": "Url where measurement was observed."
          },
          "cookie_name": {
            "type": "string",
          ...
          "raw_cookie": {
            "type": "string",
            "description": "Entire cookie string"
          },
          "observations": {
            "type": "array",
            "items": {
        ...
        "additionalProperties": false,
        "description": "\"cookie_missing_secure_attribute\" historical issues in a scorecard"
      }
    }
  },
  "additionalProperties": false,
  ...
  "description": "A page in a list of HistoricalCookieMissingSecureAttributes"
}
```
...
```bash
curl -X GET \
  'https://platform.securityscorecard.io/companies/<scorecard_identifier>/history/events/<effective_date>/issues/cookie_missing_secure_attribute/' \
