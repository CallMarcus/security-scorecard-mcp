# Get "cobalt_strike_c2_service" issues in a scoreca

- **Method:** `GET`
- **Path:** `/companies/{scorecard_identifier}/issues/cobalt_strike_c2_service`
- **Category:** `company-issues`
- **Operation ID:** `get_companies-scorecard-identifier-issues-cobalt-strike-c2-service`
...
```json
{
  ...
  "properties": {
    "entries": {
      ...
      "items": {
        ...
        "description": "\"cobalt_strike_c2_service\" issues in a scorecard"
      }
    }
  },
  "additionalProperties": false,
  ...
  "description": "A page in a list of CobaltStrikeC2Services"
}
```
...
```bash
curl -X GET \
  'https://platform.securityscorecard.io/companies/<scorecard_identifier>/issues/cobalt_strike_c2_service' \
