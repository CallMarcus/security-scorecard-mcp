...
- **Method:** `GET`
- **Path:** `/companies/{scorecard_identifier}/issues/tls_weak_protocol`
- **Category:** `company-issues`
- **Operation ID:** `get_companies-scorecard-identifier-issues-tls-weak-protocol`
...
```json
{
  ...
  "properties": {
    "entries": {
      ...
      "items": {
        ...
        "description": "\"tls_weak_protocol\" issues in a scorecard"
      }
    }
  },
  "additionalProperties": false,
  ...
  "description": "A page in a list of TlsWeakProtocols"
}
```
...
```bash
curl -X GET \
  'https://platform.securityscorecard.io/companies/<scorecard_identifier>/issues/tls_weak_protocol' \
