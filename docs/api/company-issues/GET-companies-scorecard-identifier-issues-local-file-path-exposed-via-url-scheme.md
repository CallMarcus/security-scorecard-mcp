# Get "local_file_path_exposed_via_url_scheme" issue

- **Method:** `GET`
- **Path:** `/companies/{scorecard_identifier}/issues/local_file_path_exposed_via_url_scheme`
- **Category:** `company-issues`
- **Operation ID:** `get_companies-scorecard-identifier-issues-local-file-path-exposed-via-url-scheme`
...
```json
{
  ...
  "properties": {
    "entries": {
      ...
      "items": {
        ...
        "description": "\"local_file_path_exposed_via_url_scheme\" issues in a scorecard"
      }
    }
  },
  "additionalProperties": false,
  ...
  "description": "A page in a list of LocalFilePathExposedViaUrlSchemes"
}
```
...
```bash
curl -X GET \
  'https://platform.securityscorecard.io/companies/<scorecard_identifier>/issues/local_file_path_exposed_via_url_scheme' \
