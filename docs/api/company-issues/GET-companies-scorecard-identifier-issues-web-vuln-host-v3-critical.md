# Get "web_vuln_host_v3_critical" issues in a scorec

- **Method:** `GET`
- **Path:** `/companies/{scorecard_identifier}/issues/web_vuln_host_v3_critical`
- **Category:** `company-issues`
- **Operation ID:** `get_companies-scorecard-identifier-issues-web-vuln-host-v3-critical`
...
```json
{
  ...
  "properties": {
    "entries": {
      ...
      "items": {
        ...
        "description": "\"web_vuln_host_v3_critical\" issues in a scorecard"
      }
    }
  },
  "additionalProperties": false,
  ...
  "description": "A page in a list of WebVulnHostV3Criticals"
}
```
...
```bash
curl -X GET \
  'https://platform.securityscorecard.io/companies/<scorecard_identifier>/issues/web_vuln_host_v3_critical' \
