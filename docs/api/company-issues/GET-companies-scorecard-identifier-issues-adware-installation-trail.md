...
- **Method:** `GET`
- **Path:** `/companies/{scorecard_identifier}/issues/adware_installation_trail`
- **Category:** `company-issues`
- **Operation ID:** `get_companies-scorecard-identifier-issues-adware-installation-trail`
...
```json
{
  ...
  "properties": {
    "entries": {
      ...
      "items": {
        ...
        "description": "\"adware_installation_trail\" issues in a scorecard"
      }
    }
  },
  "additionalProperties": false,
  ...
  "description": "A page in a list of AdwareInstallationTrails"
}
```
...
```bash
curl -X GET \
  'https://platform.securityscorecard.io/companies/<scorecard_identifier>/issues/adware_installation_trail' \
