# Get "fail_to_load_page_components" issues in a sco

- **Method:** `GET`
- **Path:** `/companies/{scorecard_identifier}/issues/fail_to_load_page_components`
- **Category:** `company-issues`
- **Operation ID:** `get_companies-scorecard-identifier-issues-fail-to-load-page-components`
...
```json
{
  ...
  "properties": {
    "entries": {
      ...
      "items": {
        ...
        "description": "\"fail_to_load_page_components\" issues in a scorecard"
      }
    }
  },
  "additionalProperties": false,
  ...
  "description": "A page in a list of FailToLoadPageComponents"
}
```
...
```bash
curl -X GET \
  'https://platform.securityscorecard.io/companies/<scorecard_identifier>/issues/fail_to_load_page_components' \
