# Get "mirai_botnet_traffic_detected" issues in a sc

- **Method:** `GET`
- **Path:** `/companies/{scorecard_identifier}/issues/mirai_botnet_traffic_detected`
- **Category:** `company-issues`
- **Operation ID:** `get_companies-scorecard-identifier-issues-mirai-botnet-traffic-detected`
...
```json
{
  ...
  "properties": {
    "entries": {
      ...
      "items": {
        ...
        "description": "\"mirai_botnet_traffic_detected\" issues in a scorecard"
      }
    }
  },
  "additionalProperties": false,
  ...
  "description": "A page in a list of MiraiBotnetTrafficDetecteds"
}
```
...
```bash
curl -X GET \
  'https://platform.securityscorecard.io/companies/<scorecard_identifier>/issues/mirai_botnet_traffic_detected' \
