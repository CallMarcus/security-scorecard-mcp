# Get "links_to_insecure_website" issues in a scorec

- **Method:** `GET`
- **Path:** `/companies/{scorecard_identifier}/issues/links_to_insecure_website`
- **Category:** `company-issues`
- **Operation ID:** `get_companies-scorecard-identifier-issues-links-to-insecure-website`
...
```json
{
  ...
  "properties": {
    "entries": {
      ...
      "items": {
        ...
        "description": "\"links_to_insecure_website\" issues in a scorecard"
      }
    }
  },
  "additionalProperties": false,
  ...
  "description": "A page in a list of LinksToInsecureWebsites"
}
```
...
```bash
curl -X GET \
  'https://platform.securityscorecard.io/companies/<scorecard_identifier>/issues/links_to_insecure_website' \
