...
- **Method:** `GET`
- **Path:** `/companies/{scorecard_identifier}/issues/ransomware_association`
- **Category:** `company-issues`
- **Operation ID:** `get_companies-scorecard-identifier-issues-ransomware-association`
...
```json
{
  ...
  "properties": {
    "entries": {
      ...
      "items": {
        ...
        "description": "\"ransomware_association\" issues in a scorecard"
      }
    }
  },
  "additionalProperties": false,
  ...
  "description": "A page in a list of RansomwareAssociations"
}
```
...
```bash
curl -X GET \
  'https://platform.securityscorecard.io/companies/<scorecard_identifier>/issues/ransomware_association' \
