# Get "dkim_weak_signature" historical issues in a s

- **Method:** `GET`
- **Path:** `/companies/{scorecard_identifier}/history/events/{effective_date}/issues/dkim_weak_signature/`
- **Category:** `company-issues`
- **Operation ID:** `get_companies-scorecard-identifier-history-events-effective-date-issues-dkim-weak-signature`

## Description

Get "dkim_weak_signature" historical issues in a scorecard
...
### 200
A page in a list of HistoricalDkimWeakSignatures
```json
{
  "type": "object",
  "properties": {
    "entries": {
      ...
      "items": {
        ...
        "additionalProperties": false,
        "description": "\"dkim_weak_signature\" historical issues in a scorecard"
      }
    }
  },
  "additionalProperties": false,
  ...
  "description": "A page in a list of HistoricalDkimWeakSignatures"
}
```
...
```bash
curl -X GET \
  'https://platform.securityscorecard.io/companies/<scorecard_identifier>/history/events/<effective_date>/issues/dkim_weak_signature/' \
