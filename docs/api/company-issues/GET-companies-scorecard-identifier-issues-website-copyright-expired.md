# Get "website_copyright_expired" issues in a scorec

- **Method:** `GET`
- **Path:** `/companies/{scorecard_identifier}/issues/website_copyright_expired`
- **Category:** `company-issues`
- **Operation ID:** `get_companies-scorecard-identifier-issues-website-copyright-expired`
...
```json
{
  ...
  "properties": {
    "entries": {
      ...
      "items": {
        ...
        "description": "\"website_copyright_expired\" issues in a scorecard"
      }
    }
  },
  "additionalProperties": false,
  ...
  "description": "A page in a list of WebsiteCopyrightExpireds"
}
```
...
```bash
curl -X GET \
  'https://platform.securityscorecard.io/companies/<scorecard_identifier>/issues/website_copyright_expired' \
