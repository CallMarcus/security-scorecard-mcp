# Get "dkim_insufficient_key_length" issues in a sco

- **Method:** `GET`
- **Path:** `/companies/{scorecard_identifier}/issues/dkim_insufficient_key_length`
- **Category:** `company-issues`
- **Operation ID:** `get_companies-scorecard-identifier-issues-dkim-insufficient-key-length`

## Description

Get "dkim_insufficient_key_length" issues in a scorecard
...
### 200
A page in a list of DkimInsufficientKeyLengths
```json
{
  "type": "object",
  "properties": {
    "entries": {
      ...
      "items": {
        ...
        "description": "\"dkim_insufficient_key_length\" issues in a scorecard"
      }
    }
  },
  "additionalProperties": false,
  ...
  "description": "A page in a list of DkimInsufficientKeyLengths"
}
```
...
```bash
curl -X GET \
  'https://platform.securityscorecard.io/companies/<scorecard_identifier>/issues/dkim_insufficient_key_length' \
