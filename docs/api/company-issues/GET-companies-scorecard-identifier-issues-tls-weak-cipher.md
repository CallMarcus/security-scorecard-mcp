...
- **Method:** `GET`
- **Path:** `/companies/{scorecard_identifier}/issues/tls_weak_cipher`
- **Category:** `company-issues`
- **Operation ID:** `get_companies-scorecard-identifier-issues-tls-weak-cipher`
...
```json
{
  ...
  "properties": {
    "entries": {
      ...
      "items": {
        ...
        "description": "\"tls_weak_cipher\" issues in a scorecard"
      }
    }
  },
  "additionalProperties": false,
  ...
  "description": "A page in a list of TlsWeakCiphers"
}
```
...
```bash
curl -X GET \
  'https://platform.securityscorecard.io/companies/<scorecard_identifier>/issues/tls_weak_cipher' \
