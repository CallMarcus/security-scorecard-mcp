# Get "ip_black_list_due_malicious_activity" issues 

- **Method:** `GET`
- **Path:** `/companies/{scorecard_identifier}/issues/ip_black_list_due_malicious_activity`
- **Category:** `company-issues`
- **Operation ID:** `get_companies-scorecard-identifier-issues-ip-black-list-due-malicious-activity`
...
```json
{
  ...
  "properties": {
    "entries": {
      ...
      "items": {
        ...
        "description": "\"ip_black_list_due_malicious_activity\" issues in a scorecard"
      }
    }
  },
  "additionalProperties": false,
  ...
  "description": "A page in a list of IpBlackListDueMaliciousActivities"
}
```
...
```bash
curl -X GET \
  'https://platform.securityscorecard.io/companies/<scorecard_identifier>/issues/ip_black_list_due_malicious_activity' \
