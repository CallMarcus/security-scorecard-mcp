...
- **Method:** `GET`
- **Path:** `/companies/{scorecard_identifier}/issues/ssh_weak_cipher`
- **Category:** `company-issues`
- **Operation ID:** `get_companies-scorecard-identifier-issues-ssh-weak-cipher`
...
```json
{
  ...
  "properties": {
    "entries": {
      ...
      "items": {
        ...
        "description": "\"ssh_weak_cipher\" issues in a scorecard"
      }
    }
  },
  "additionalProperties": false,
  ...
  "description": "A page in a list of SshWeakCiphers"
}
```
...
```bash
curl -X GET \
  'https://platform.securityscorecard.io/companies/<scorecard_identifier>/issues/ssh_weak_cipher' \
