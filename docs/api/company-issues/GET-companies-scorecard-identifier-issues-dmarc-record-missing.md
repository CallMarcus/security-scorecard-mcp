# Get "dmarc_record_missing" issues in a scorecard

- **Method:** `GET`
- **Path:** `/companies/{scorecard_identifier}/issues/dmarc_record_missing`
- **Category:** `company-issues`
- **Operation ID:** `get_companies-scorecard-identifier-issues-dmarc-record-missing`
...
```json
{
  ...
  "properties": {
    "entries": {
      ...
      "items": {
        ...
        "description": "\"dmarc_record_missing\" issues in a scorecard"
      }
    }
  },
  "additionalProperties": false,
  ...
  "description": "A page in a list of DmarcRecordMissings"
}
```
...
```bash
curl -X GET \
  'https://platform.securityscorecard.io/companies/<scorecard_identifier>/issues/dmarc_record_missing' \
