# Get "insecure_server_certificate_key_size" issues 

- **Method:** `GET`
- **Path:** `/companies/{scorecard_identifier}/issues/insecure_server_certificate_key_size`
- **Category:** `company-issues`
- **Operation ID:** `get_companies-scorecard-identifier-issues-insecure-server-certificate-key-size`
...
```json
{
  ...
  "properties": {
    "entries": {
      ...
      "items": {
        ...
        "description": "\"insecure_server_certificate_key_size\" issues in a scorecard"
      }
    }
  },
  "additionalProperties": false,
  ...
  "description": "A page in a list of InsecureServerCertificateKeySizes"
}
```
...
```bash
curl -X GET \
  'https://platform.securityscorecard.io/companies/<scorecard_identifier>/issues/insecure_server_certificate_key_size' \
