# Get "references_object_storage_v2" issues in a sco

- **Method:** `GET`
- **Path:** `/companies/{scorecard_identifier}/issues/references_object_storage_v2`
- **Category:** `company-issues`
- **Operation ID:** `get_companies-scorecard-identifier-issues-references-object-storage-v2`
...
```json
{
  ...
  "properties": {
    "entries": {
      ...
      "items": {
        ...
        "description": "\"references_object_storage_v2\" issues in a scorecard"
      }
    }
  },
  "additionalProperties": false,
  ...
  "description": "A page in a list of ReferencesObjectStorageV2s"
}
```
...
```bash
curl -X GET \
  'https://platform.securityscorecard.io/companies/<scorecard_identifier>/issues/references_object_storage_v2' \
