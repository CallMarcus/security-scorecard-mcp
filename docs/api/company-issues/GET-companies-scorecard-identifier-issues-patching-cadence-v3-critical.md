# Get "patching_cadence_v3_critical" issues in a sco

- **Method:** `GET`
- **Path:** `/companies/{scorecard_identifier}/issues/patching_cadence_v3_critical`
- **Category:** `company-issues`
- **Operation ID:** `get_companies-scorecard-identifier-issues-patching-cadence-v3-critical`
...
```json
{
  ...
  "properties": {
    "entries": {
      ...
      "items": {
        ...
        "description": "\"patching_cadence_v3_critical\" issues in a scorecard"
      }
    }
  },
  "additionalProperties": false,
  ...
  "description": "A page in a list of PatchingCadenceV3Criticals"
}
```
...
```bash
curl -X GET \
  'https://platform.securityscorecard.io/companies/<scorecard_identifier>/issues/patching_cadence_v3_critical' \
