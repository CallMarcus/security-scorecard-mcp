# Get "exposed_network_attached_storage_device" issu

- **Method:** `GET`
- **Path:** `/companies/{scorecard_identifier}/issues/exposed_network_attached_storage_device`
- **Category:** `company-issues`
- **Operation ID:** `get_companies-scorecard-identifier-issues-exposed-network-attached-storage-device`
...
```json
{
  ...
  "properties": {
    "entries": {
      ...
      "items": {
        ...
        "description": "\"exposed_network_attached_storage_device\" issues in a scorecard"
      }
    }
  },
  "additionalProperties": false,
  ...
  "description": "A page in a list of ExposedNetworkAttachedStorageDevices"
}
```
...
```bash
curl -X GET \
  'https://platform.securityscorecard.io/companies/<scorecard_identifier>/issues/exposed_network_attached_storage_device' \
