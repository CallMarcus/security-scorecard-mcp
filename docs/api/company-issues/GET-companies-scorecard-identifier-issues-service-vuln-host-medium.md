# Get "service_vuln_host_medium" issues in a scoreca

- **Method:** `GET`
- **Path:** `/companies/{scorecard_identifier}/issues/service_vuln_host_medium`
- **Category:** `company-issues`
- **Operation ID:** `get_companies-scorecard-identifier-issues-service-vuln-host-medium`
...
```json
{
  ...
  "properties": {
    "entries": {
      ...
      "items": {
        ...
        "description": "\"service_vuln_host_medium\" issues in a scorecard"
      }
    }
  },
  "additionalProperties": false,
  ...
  "description": "A page in a list of ServiceVulnHostMediums"
}
```
...
```bash
curl -X GET \
  'https://platform.securityscorecard.io/companies/<scorecard_identifier>/issues/service_vuln_host_medium' \
