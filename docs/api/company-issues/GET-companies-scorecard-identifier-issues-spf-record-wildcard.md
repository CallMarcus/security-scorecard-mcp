...
- **Method:** `GET`
- **Path:** `/companies/{scorecard_identifier}/issues/spf_record_wildcard`
- **Category:** `company-issues`
- **Operation ID:** `get_companies-scorecard-identifier-issues-spf-record-wildcard`
...
```json
{
  ...
  "properties": {
    "entries": {
      ...
      "items": {
        ...
        "description": "\"spf_record_wildcard\" issues in a scorecard"
      }
    }
  },
  "additionalProperties": false,
  ...
  "description": "A page in a list of SpfRecordWildcards"
}
```
...
```bash
curl -X GET \
  'https://platform.securityscorecard.io/companies/<scorecard_identifier>/issues/spf_record_wildcard' \
