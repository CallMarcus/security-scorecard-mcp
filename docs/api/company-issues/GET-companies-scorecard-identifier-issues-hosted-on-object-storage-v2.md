# Get "hosted_on_object_storage_v2" issues in a scor

- **Method:** `GET`
- **Path:** `/companies/{scorecard_identifier}/issues/hosted_on_object_storage_v2`
- **Category:** `company-issues`
- **Operation ID:** `get_companies-scorecard-identifier-issues-hosted-on-object-storage-v2`
...
```json
{
  ...
  "properties": {
    "entries": {
      ...
      "items": {
        ...
        "description": "\"hosted_on_object_storage_v2\" issues in a scorecard"
      }
    }
  },
  "additionalProperties": false,
  ...
  "description": "A page in a list of HostedOnObjectStorageV2s"
}
```
...
```bash
curl -X GET \
  'https://platform.securityscorecard.io/companies/<scorecard_identifier>/issues/hosted_on_object_storage_v2' \
