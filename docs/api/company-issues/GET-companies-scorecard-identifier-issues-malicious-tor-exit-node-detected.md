# Get "malicious_tor_exit_node_detected" issues in a

- **Method:** `GET`
- **Path:** `/companies/{scorecard_identifier}/issues/malicious_tor_exit_node_detected`
- **Category:** `company-issues`
- **Operation ID:** `get_companies-scorecard-identifier-issues-malicious-tor-exit-node-detected`
...
```json
{
  ...
  "properties": {
    "entries": {
      ...
      "items": {
        ...
        "description": "\"malicious_tor_exit_node_detected\" issues in a scorecard"
      }
    }
  },
  "additionalProperties": false,
  ...
  "description": "A page in a list of MaliciousTorExitNodeDetecteds"
}
```
...
```bash
curl -X GET \
  'https://platform.securityscorecard.io/companies/<scorecard_identifier>/issues/malicious_tor_exit_node_detected' \
