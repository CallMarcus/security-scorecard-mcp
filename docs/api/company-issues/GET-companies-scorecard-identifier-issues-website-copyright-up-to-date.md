# Get "website_copyright_up_to_date" issues in a sco

- **Method:** `GET`
- **Path:** `/companies/{scorecard_identifier}/issues/website_copyright_up_to_date`
- **Category:** `company-issues`
- **Operation ID:** `get_companies-scorecard-identifier-issues-website-copyright-up-to-date`
...
```json
{
  ...
  "properties": {
    "entries": {
      ...
      "items": {
        ...
        "description": "\"website_copyright_up_to_date\" issues in a scorecard"
      }
    }
  },
  "additionalProperties": false,
  ...
  "description": "A page in a list of WebsiteCopyrightUpToDates"
}
```
...
```bash
curl -X GET \
  'https://platform.securityscorecard.io/companies/<scorecard_identifier>/issues/website_copyright_up_to_date' \
