# Get "targeted_by_threat_actor_group" historical is

- **Method:** `GET`
- **Path:** `/companies/{scorecard_identifier}/history/events/{effective_date}/issues/targeted_by_threat_actor_group/`
- **Category:** `company-issues`
- **Operation ID:** `get_companies-scorecard-identifier-history-events-effective-date-issues-targeted-by-threat-actor-group`

## Description

Get "targeted_by_threat_actor_group" historical issues in a scorecard
...
### 200
A page in a list of HistoricalTargetedByThreatActorGroups
```json
{
  "type": "object",
  "properties": {
    "entries": {
      ...
      "items": {
        ...
        "additionalProperties": false,
        "description": "\"targeted_by_threat_actor_group\" historical issues in a scorecard"
      }
    }
  },
  "additionalProperties": false,
  ...
  "description": "A page in a list of HistoricalTargetedByThreatActorGroups"
}
```
...
```bash
curl -X GET \
  'https://platform.securityscorecard.io/companies/<scorecard_identifier>/history/events/<effective_date>/issues/targeted_by_threat_actor_group/' \
