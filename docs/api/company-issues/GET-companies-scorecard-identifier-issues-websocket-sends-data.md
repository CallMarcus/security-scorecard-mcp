...
- **Method:** `GET`
- **Path:** `/companies/{scorecard_identifier}/issues/websocket_sends_data`
- **Category:** `company-issues`
- **Operation ID:** `get_companies-scorecard-identifier-issues-websocket-sends-data`
...
```json
{
  ...
  "properties": {
    "entries": {
      ...
      "items": {
        ...
        "description": "\"websocket_sends_data\" issues in a scorecard"
      }
    }
  },
  "additionalProperties": false,
  ...
  "description": "A page in a list of WebsocketSendsData"
}
```
...
```bash
curl -X GET \
  'https://platform.securityscorecard.io/companies/<scorecard_identifier>/issues/websocket_sends_data' \
