# Get "synth_high_risk_appsec_vulnerabilities" issue

- **Method:** `GET`
- **Path:** `/companies/{scorecard_identifier}/issues/synth_high_risk_appsec_vulnerabilities`
- **Category:** `company-issues`
- **Operation ID:** `get_companies-scorecard-identifier-issues-synth-high-risk-appsec-vulnerabilities`

## Description

Get "synth_high_risk_appsec_vulnerabilities" issues in a scorecard
...
### 200
A page in a list of SynthHighRiskAppsecVulnerabilities
```json
{
  "type": "object",
  "properties": {
    "entries": {
      ...
      "items": {
        ...
        "description": "\"synth_high_risk_appsec_vulnerabilities\" issues in a scorecard"
      }
    }
  },
  "additionalProperties": false,
  ...
  "description": "A page in a list of SynthHighRiskAppsecVulnerabilities"
}
```
...
```bash
curl -X GET \
  'https://platform.securityscorecard.io/companies/<scorecard_identifier>/issues/synth_high_risk_appsec_vulnerabilities' \
