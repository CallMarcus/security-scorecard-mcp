...
- **Method:** `GET`
- **Path:** `/companies/{scorecard_identifier}/issues/tls_ocsp_stapling`
- **Category:** `company-issues`
- **Operation ID:** `get_companies-scorecard-identifier-issues-tls-ocsp-stapling`
...
```json
{
  ...
  "properties": {
    "entries": {
      ...
      "items": {
        ...
        "description": "\"tls_ocsp_stapling\" issues in a scorecard"
      }
    }
  },
  "additionalProperties": false,
  ...
  "description": "A page in a list of TlsOcspStaplings"
}
```
...
```bash
curl -X GET \
  'https://platform.securityscorecard.io/companies/<scorecard_identifier>/issues/tls_ocsp_stapling' \
