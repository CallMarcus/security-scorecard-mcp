# Get "malicious_user_agent_detected" issues in a sc

- **Method:** `GET`
- **Path:** `/companies/{scorecard_identifier}/issues/malicious_user_agent_detected`
- **Category:** `company-issues`
- **Operation ID:** `get_companies-scorecard-identifier-issues-malicious-user-agent-detected`
...
```json
{
  ...
  "properties": {
    "entries": {
      ...
      "items": {
        ...
        "description": "\"malicious_user_agent_detected\" issues in a scorecard"
      }
    }
  },
  "additionalProperties": false,
  ...
  "description": "A page in a list of MaliciousUserAgentDetecteds"
}
```
...
```bash
curl -X GET \
  'https://platform.securityscorecard.io/companies/<scorecard_identifier>/issues/malicious_user_agent_detected' \
