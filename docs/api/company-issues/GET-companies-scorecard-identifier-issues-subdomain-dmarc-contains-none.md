# Get "subdomain_dmarc_contains_none" issues in a sc

- **Method:** `GET`
- **Path:** `/companies/{scorecard_identifier}/issues/subdomain_dmarc_contains_none`
- **Category:** `company-issues`
- **Operation ID:** `get_companies-scorecard-identifier-issues-subdomain-dmarc-contains-none`

## Description

Get "subdomain_dmarc_contains_none" issues in a scorecard
...
```json
{
  ...
  "properties": {
    "entries": {
      ...
      "items": {
        ...
        "description": "\"subdomain_dmarc_contains_none\" issues in a scorecard"
      }
    }
  },
  "additionalProperties": false,
  ...
  "description": "A page in a list of SubdomainDmarcContainsNones"
}
```
...
```bash
curl -X GET \
  'https://platform.securityscorecard.io/companies/<scorecard_identifier>/issues/subdomain_dmarc_contains_none' \
