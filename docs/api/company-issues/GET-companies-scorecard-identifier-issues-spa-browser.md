...
- **Method:** `GET`
- **Path:** `/companies/{scorecard_identifier}/issues/spa_browser`
- **Category:** `company-issues`
- **Operation ID:** `get_companies-scorecard-identifier-issues-spa-browser`
...
```json
{
  ...
  "properties": {
    "entries": {
      ...
      "items": {
        ...
        "description": "\"spa_browser\" issues in a scorecard"
      }
    }
  },
  "additionalProperties": false,
  ...
  "description": "A page in a list of SpaBrowsers"
}
```
...
```bash
curl -X GET \
  'https://platform.securityscorecard.io/companies/<scorecard_identifier>/issues/spa_browser' \
