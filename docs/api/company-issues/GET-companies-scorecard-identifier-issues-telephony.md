...
- **Method:** `GET`
- **Path:** `/companies/{scorecard_identifier}/issues/telephony`
- **Category:** `company-issues`
- **Operation ID:** `get_companies-scorecard-identifier-issues-telephony`
...
### 200
A page in a list of Telephonies
```json
{
  "type": "object",
  "properties": {
    "entries": {
      ...
      "items": {
        ...
        "description": "\"telephony\" issues in a scorecard"
      }
    }
  },
  "additionalProperties": false,
  ...
  "description": "A page in a list of Telephonies"
}
```
...
```bash
curl -X GET \
  'https://platform.securityscorecard.io/companies/<scorecard_identifier>/issues/telephony' \
