# Get "uses_go_daddy_managed_wordpress" issues in a 

- **Method:** `GET`
- **Path:** `/companies/{scorecard_identifier}/issues/uses_go_daddy_managed_wordpress`
- **Category:** `company-issues`
- **Operation ID:** `get_companies-scorecard-identifier-issues-uses-go-daddy-managed-wordpress`
...
```json
{
  ...
  "properties": {
    "entries": {
      ...
      "items": {
        ...
        "description": "\"uses_go_daddy_managed_wordpress\" issues in a scorecard"
      }
    }
  },
  "additionalProperties": false,
  ...
  "description": "A page in a list of UsesGoDaddyManagedWordpresses"
}
```
...
```bash
curl -X GET \
  'https://platform.securityscorecard.io/companies/<scorecard_identifier>/issues/uses_go_daddy_managed_wordpress' \
