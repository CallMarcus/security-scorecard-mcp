...
- **Method:** `GET`
- **Path:** `/companies/{scorecard_identifier}/issues/tlscert_expired`
- **Category:** `company-issues`
- **Operation ID:** `get_companies-scorecard-identifier-issues-tlscert-expired`
...
```json
{
  ...
  "properties": {
    "entries": {
      ...
      "items": {
        ...
        "description": "\"tlscert_expired\" issues in a scorecard"
      }
    }
  },
  "additionalProperties": false,
  ...
  "description": "A page in a list of TlscertExpireds"
}
```
...
```bash
curl -X GET \
  'https://platform.securityscorecard.io/companies/<scorecard_identifier>/issues/tlscert_expired' \
