...
- **Method:** `GET`
- **Path:** `/companies/{scorecard_identifier}/issues/alleged_breach_incident`
- **Category:** `company-issues`
- **Operation ID:** `get_companies-scorecard-identifier-issues-alleged-breach-incident`
...
```json
{
  ...
  "properties": {
    "entries": {
      ...
      "items": {
        ...
        "description": "\"alleged_breach_incident\" issues in a scorecard"
      }
    }
  },
  "additionalProperties": false,
  ...
  "description": "A page in a list of AllegedBreachIncidents"
}
```
...
```bash
curl -X GET \
  'https://platform.securityscorecard.io/companies/<scorecard_identifier>/issues/alleged_breach_incident' \
