...
- **Method:** `GET`
- **Path:** `/companies/{scorecard_identifier}/issues/adware_installation`
- **Category:** `company-issues`
- **Operation ID:** `get_companies-scorecard-identifier-issues-adware-installation`
...
### 200
A page in a list of AdwareInstallations
```json
{
  "type": "object",
  "properties": {
    "entries": {
      ...
      "items": {
        ...
        "description": "\"adware_installation\" issues in a scorecard"
      }
    }
  },
  "additionalProperties": false,
  ...
  "description": "A page in a list of AdwareInstallations"
}
```
...
```bash
curl -X GET \
  'https://platform.securityscorecard.io/companies/<scorecard_identifier>/issues/adware_installation' \
