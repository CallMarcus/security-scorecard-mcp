# Get "cookie_missing_http_only" issues in a scoreca

- **Method:** `GET`
- **Path:** `/companies/{scorecard_identifier}/issues/cookie_missing_http_only`
- **Category:** `company-issues`
- **Operation ID:** `get_companies-scorecard-identifier-issues-cookie-missing-http-only`
...
### 200
A page in a list of CookieMissingHttpOnlies
```json
{
  "type": "object",
  "properties": {
    "entries": {
      ...
      "items": {
        ...
        "description": "\"cookie_missing_http_only\" issues in a scorecard"
      }
    }
  },
  "additionalProperties": false,
  ...
  "description": "A page in a list of CookieMissingHttpOnlies"
}
```
...
```bash
curl -X GET \
  'https://platform.securityscorecard.io/companies/<scorecard_identifier>/issues/cookie_missing_http_only' \
