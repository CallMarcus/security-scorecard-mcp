# Get "domain_missing_https_v2" issues in a scorecar

- **Method:** `GET`
- **Path:** `/companies/{scorecard_identifier}/issues/domain_missing_https_v2`
- **Category:** `company-issues`
- **Operation ID:** `get_companies-scorecard-identifier-issues-domain-missing-https-v2`
...
```json
{
  ...
  "properties": {
    "entries": {
      ...
      "items": {
        ...
        "description": "\"domain_missing_https_v2\" issues in a scorecard"
      }
    }
  },
  "additionalProperties": false,
  ...
  "description": "A page in a list of DomainMissingHttpsV2s"
}
```
...
```bash
curl -X GET \
  'https://platform.securityscorecard.io/companies/<scorecard_identifier>/issues/domain_missing_https_v2' \
