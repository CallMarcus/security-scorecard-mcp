# Get "product_uses_vulnerable_log4j" issues in a sc

- **Method:** `GET`
- **Path:** `/companies/{scorecard_identifier}/issues/product_uses_vulnerable_log4j`
- **Category:** `company-issues`
- **Operation ID:** `get_companies-scorecard-identifier-issues-product-uses-vulnerable-log4j`
...
```json
{
  ...
  "properties": {
    "entries": {
      ...
      "items": {
        ...
        "description": "\"product_uses_vulnerable_log4j\" issues in a scorecard"
      }
    }
  },
  "additionalProperties": false,
  ...
  "description": "A page in a list of ProductUsesVulnerableLog4JS"
}
```
...
```bash
curl -X GET \
  'https://platform.securityscorecard.io/companies/<scorecard_identifier>/issues/product_uses_vulnerable_log4j' \
