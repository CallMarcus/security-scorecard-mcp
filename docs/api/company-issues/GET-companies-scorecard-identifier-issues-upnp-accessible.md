...
- **Method:** `GET`
- **Path:** `/companies/{scorecard_identifier}/issues/upnp_accessible`
- **Category:** `company-issues`
- **Operation ID:** `get_companies-scorecard-identifier-issues-upnp-accessible`
...
```json
{
  ...
  "properties": {
    "entries": {
      ...
      "items": {
        ...
        "description": "\"upnp_accessible\" issues in a scorecard"
      }
    }
  },
  "additionalProperties": false,
  ...
  "description": "A page in a list of UpnpAccessibles"
}
```
...
```bash
curl -X GET \
  'https://platform.securityscorecard.io/companies/<scorecard_identifier>/issues/upnp_accessible' \
