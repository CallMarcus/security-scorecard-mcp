# Get "browser_logs_contain_debug_message" issues in

- **Method:** `GET`
- **Path:** `/companies/{scorecard_identifier}/issues/browser_logs_contain_debug_message`
- **Category:** `company-issues`
- **Operation ID:** `get_companies-scorecard-identifier-issues-browser-logs-contain-debug-message`
...
```json
{
  ...
  "properties": {
    "entries": {
      ...
      "items": {
        ...
        "description": "\"browser_logs_contain_debug_message\" issues in a scorecard"
      }
    }
  },
  "additionalProperties": false,
  ...
  "description": "A page in a list of BrowserLogsContainDebugMessages"
}
```
...
```bash
curl -X GET \
  'https://platform.securityscorecard.io/companies/<scorecard_identifier>/issues/browser_logs_contain_debug_message' \
