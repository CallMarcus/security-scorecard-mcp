...
- **Method:** `GET`
- **Path:** `/companies/{scorecard_identifier}/issues/sensitive_data_exposure_through_insecure_channel`
- **Category:** `company-issues`
- **Operation ID:** `get_companies-scorecard-identifier-issues-sensitive-data-exposure-through-insecure-channel`
...
### 200
A page in a list of SensitiveDataExposureThroughInsecureChannels
```json
{
  "type": "object",
  "properties": {
    "entries": {
      ...
      "items": {
        ...
        "description": "\"sensitive_data_exposure_through_insecure_channel\" issues in a scorecard"
      }
    }
  },
  "additionalProperties": false,
  ...
  "description": "A page in a list of SensitiveDataExposureThroughInsecureChannels"
}
```
...
```bash
curl -X GET \
  'https://platform.securityscorecard.io/companies/<scorecard_identifier>/issues/sensitive_data_exposure_through_insecure_channel' \
