# Get "data_leak_detected" issues in a scorecard

- **Method:** `GET`
- **Path:** `/companies/{scorecard_identifier}/issues/data_leak_detected`
- **Category:** `company-issues`
- **Operation ID:** `get_companies-scorecard-identifier-issues-data-leak-detected`
...
### 200
A page in a list of DataLeakDetecteds
```json
{
  "type": "object",
  "properties": {
    "entries": {
      ...
      "items": {
        ...
        "description": "\"data_leak_detected\" issues in a scorecard"
      }
    }
  },
  "additionalProperties": false,
  ...
  "description": "A page in a list of DataLeakDetecteds"
}
```
...
```bash
curl -X GET \
  'https://platform.securityscorecard.io/companies/<scorecard_identifier>/issues/data_leak_detected' \
