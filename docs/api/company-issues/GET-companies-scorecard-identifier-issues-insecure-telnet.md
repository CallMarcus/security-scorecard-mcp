...
- **Method:** `GET`
- **Path:** `/companies/{scorecard_identifier}/issues/insecure_telnet`
- **Category:** `company-issues`
- **Operation ID:** `get_companies-scorecard-identifier-issues-insecure-telnet`
...
```json
{
  ...
  "properties": {
    "entries": {
      ...
      "items": {
        ...
        "description": "\"insecure_telnet\" issues in a scorecard"
      }
    }
  },
  "additionalProperties": false,
  ...
  "description": "A page in a list of InsecureTelnets"
}
```
...
```bash
curl -X GET \
  'https://platform.securityscorecard.io/companies/<scorecard_identifier>/issues/insecure_telnet' \
