# Get "patching_cadence_medium" issues in a scorecar

- **Method:** `GET`
- **Path:** `/companies/{scorecard_identifier}/issues/patching_cadence_medium`
- **Category:** `company-issues`
- **Operation ID:** `get_companies-scorecard-identifier-issues-patching-cadence-medium`
...
```json
{
  ...
  "properties": {
    "entries": {
      ...
      "items": {
        ...
        "description": "\"patching_cadence_medium\" issues in a scorecard"
      }
    }
  },
  "additionalProperties": false,
  ...
  "description": "A page in a list of PatchingCadenceMediums"
}
```
...
```bash
curl -X GET \
  'https://platform.securityscorecard.io/companies/<scorecard_identifier>/issues/patching_cadence_medium' \
