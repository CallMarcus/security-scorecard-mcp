# Get "mysql_server_empty_password" issues in a scor

- **Method:** `GET`
- **Path:** `/companies/{scorecard_identifier}/issues/mysql_server_empty_password`
- **Category:** `company-issues`
- **Operation ID:** `get_companies-scorecard-identifier-issues-mysql-server-empty-password`
...
```json
{
  ...
  "properties": {
    "entries": {
      ...
      "items": {
        ...
        "description": "\"mysql_server_empty_password\" issues in a scorecard"
      }
    }
  },
  "additionalProperties": false,
  ...
  "description": "A page in a list of MysqlServerEmptyPasswords"
}
```
...
```bash
curl -X GET \
  'https://platform.securityscorecard.io/companies/<scorecard_identifier>/issues/mysql_server_empty_password' \
