...
- **Method:** `GET`
- **Path:** `/companies/{scorecard_identifier}/issues/patching_cadence_high`
- **Category:** `company-issues`
- **Operation ID:** `get_companies-scorecard-identifier-issues-patching-cadence-high`
...
```json
{
  ...
  "properties": {
    "entries": {
      ...
      "items": {
        ...
        "description": "\"patching_cadence_high\" issues in a scorecard"
      }
    }
  },
  "additionalProperties": false,
  ...
  "description": "A page in a list of PatchingCadenceHighs"
}
```
...
```bash
curl -X GET \
  'https://platform.securityscorecard.io/companies/<scorecard_identifier>/issues/patching_cadence_high' \
