...
- **Method:** `GET`
- **Path:** `/companies/{scorecard_identifier}/issues/service_elasticsearch`
- **Category:** `company-issues`
- **Operation ID:** `get_companies-scorecard-identifier-issues-service-elasticsearch`
...
```json
{
  ...
  "properties": {
    "entries": {
      ...
      "items": {
        ...
        "description": "\"service_elasticsearch\" issues in a scorecard"
      }
    }
  },
  "additionalProperties": false,
  ...
  "description": "A page in a list of ServiceElasticsearches"
}
```
...
```bash
curl -X GET \
  'https://platform.securityscorecard.io/companies/<scorecard_identifier>/issues/service_elasticsearch' \
