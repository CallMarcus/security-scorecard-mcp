# Get "uses_go_daddy_infrastructure" issues in a sco

- **Method:** `GET`
- **Path:** `/companies/{scorecard_identifier}/issues/uses_go_daddy_infrastructure`
- **Category:** `company-issues`
- **Operation ID:** `get_companies-scorecard-identifier-issues-uses-go-daddy-infrastructure`
...
```json
{
  ...
  "properties": {
    "entries": {
      ...
      "items": {
        ...
        "description": "\"uses_go_daddy_infrastructure\" issues in a scorecard"
      }
    }
  },
  "additionalProperties": false,
  ...
  "description": "A page in a list of UsesGoDaddyInfrastructures"
}
```
...
```bash
curl -X GET \
  'https://platform.securityscorecard.io/companies/<scorecard_identifier>/issues/uses_go_daddy_infrastructure' \
