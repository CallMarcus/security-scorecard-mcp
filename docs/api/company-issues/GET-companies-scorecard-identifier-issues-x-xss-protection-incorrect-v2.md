# Get "x_xss_protection_incorrect_v2" issues in a sc

- **Method:** `GET`
- **Path:** `/companies/{scorecard_identifier}/issues/x_xss_protection_incorrect_v2`
- **Category:** `company-issues`
- **Operation ID:** `get_companies-scorecard-identifier-issues-x-xss-protection-incorrect-v2`
...
```json
{
  ...
  "properties": {
    "entries": {
      ...
      "items": {
        ...
        "description": "\"x_xss_protection_incorrect_v2\" issues in a scorecard"
      }
    }
  },
  "additionalProperties": false,
  ...
  "description": "A page in a list of XXssProtectionIncorrectV2s"
}
```
...
```bash
curl -X GET \
  'https://platform.securityscorecard.io/companies/<scorecard_identifier>/issues/x_xss_protection_incorrect_v2' \
