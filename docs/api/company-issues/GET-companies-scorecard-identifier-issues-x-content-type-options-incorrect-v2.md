# Get "x_content_type_options_incorrect_v2" issues i

- **Method:** `GET`
- **Path:** `/companies/{scorecard_identifier}/issues/x_content_type_options_incorrect_v2`
- **Category:** `company-issues`
- **Operation ID:** `get_companies-scorecard-identifier-issues-x-content-type-options-incorrect-v2`
...
```json
{
  ...
  "properties": {
    "entries": {
      ...
      "items": {
        ...
        "description": "\"x_content_type_options_incorrect_v2\" issues in a scorecard"
      }
    }
  },
  "additionalProperties": false,
  ...
  "description": "A page in a list of XContentTypeOptionsIncorrectV2s"
}
```
...
```bash
curl -X GET \
  'https://platform.securityscorecard.io/companies/<scorecard_identifier>/issues/x_content_type_options_incorrect_v2' \
