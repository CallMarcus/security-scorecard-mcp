# Get "communication_server_with_expired_cert" issue

- **Method:** `GET`
- **Path:** `/companies/{scorecard_identifier}/issues/communication_server_with_expired_cert`
- **Category:** `company-issues`
- **Operation ID:** `get_companies-scorecard-identifier-issues-communication-server-with-expired-cert`
...
```json
{
  ...
  "properties": {
    "entries": {
      ...
      "items": {
        ...
        "description": "\"communication_server_with_expired_cert\" issues in a scorecard"
      }
    }
  },
  "additionalProperties": false,
  ...
  "description": "A page in a list of CommunicationServerWithExpiredCerts"
}
```
...
```bash
curl -X GET \
  'https://platform.securityscorecard.io/companies/<scorecard_identifier>/issues/communication_server_with_expired_cert' \
