# Get "subdomain_dmarc_contains_none" historical iss

- **Method:** `GET`
- **Path:** `/companies/{scorecard_identifier}/history/events/{effective_date}/issues/subdomain_dmarc_contains_none/`
- **Category:** `company-issues`
- **Operation ID:** `get_companies-scorecard-identifier-history-events-effective-date-issues-subdomain-dmarc-contains-none`

## Description

Get "subdomain_dmarc_contains_none" historical issues in a scorecard
...
```json
{
  ...
  "properties": {
    "entries": {
      ...
      "items": {
        ...
        "additionalProperties": false,
        "description": "\"subdomain_dmarc_contains_none\" historical issues in a scorecard"
      }
    }
  },
  "additionalProperties": false,
  ...
  "description": "A page in a list of HistoricalSubdomainDmarcContainsNones"
}
```
...
```bash
curl -X GET \
  'https://platform.securityscorecard.io/companies/<scorecard_identifier>/history/events/<effective_date>/issues/subdomain_dmarc_contains_none/' \
