# Get "infected_by_targeted_attack" issues in a scor

- **Method:** `GET`
- **Path:** `/companies/{scorecard_identifier}/issues/infected_by_targeted_attack`
- **Category:** `company-issues`
- **Operation ID:** `get_companies-scorecard-identifier-issues-infected-by-targeted-attack`

## Description

Get "infected_by_targeted_attack" issues in a scorecard
...
### 200
A page in a list of InfectedByTargetedAttacks
```json
{
  "type": "object",
  "properties": {
    "entries": {
      ...
      "items": {
        ...
        "description": "\"infected_by_targeted_attack\" issues in a scorecard"
      }
    }
  },
  "additionalProperties": false,
  ...
  "description": "A page in a list of InfectedByTargetedAttacks"
}
```
...
```bash
curl -X GET \
  'https://platform.securityscorecard.io/companies/<scorecard_identifier>/issues/infected_by_targeted_attack' \
