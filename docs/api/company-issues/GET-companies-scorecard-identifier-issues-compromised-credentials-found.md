# Get "compromised_credentials_found" issues in a sc

- **Method:** `GET`
- **Path:** `/companies/{scorecard_identifier}/issues/compromised_credentials_found`
- **Category:** `company-issues`
- **Operation ID:** `get_companies-scorecard-identifier-issues-compromised-credentials-found`
...
```json
{
  ...
  "properties": {
    "entries": {
      ...
      "items": {
        ...
        "description": "\"compromised_credentials_found\" issues in a scorecard"
      }
    }
  },
  "additionalProperties": false,
  ...
  "description": "A page in a list of CompromisedCredentialsFounds"
}
```
...
```bash
curl -X GET \
  'https://platform.securityscorecard.io/companies/<scorecard_identifier>/issues/compromised_credentials_found' \
