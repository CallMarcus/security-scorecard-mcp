# Get "malicious_botnet_c_and_c_server_detected" iss

- **Method:** `GET`
- **Path:** `/companies/{scorecard_identifier}/issues/malicious_botnet_c_and_c_server_detected`
- **Category:** `company-issues`
- **Operation ID:** `get_companies-scorecard-identifier-issues-malicious-botnet-c-and-c-server-detected`
...
```json
{
  ...
  "properties": {
    "entries": {
      ...
      "items": {
        ...
        "description": "\"malicious_botnet_c_and_c_server_detected\" issues in a scorecard"
      }
    }
  },
  "additionalProperties": false,
  ...
  "description": "A page in a list of MaliciousBotnetCAndCServerDetecteds"
}
```
...
```bash
curl -X GET \
  'https://platform.securityscorecard.io/companies/<scorecard_identifier>/issues/malicious_botnet_c_and_c_server_detected' \
