...
- **Method:** `GET`
- **Path:** `/companies/{scorecard_identifier}/issues/service_end_of_life`
- **Category:** `company-issues`
- **Operation ID:** `get_companies-scorecard-identifier-issues-service-end-of-life`
...
```json
{
  ...
  "properties": {
    "entries": {
      ...
      "items": {
        ...
        "description": "\"service_end_of_life\" issues in a scorecard"
      }
    }
  },
  "additionalProperties": false,
  ...
  "description": "A page in a list of ServiceEndOfLives"
}
```
...
```bash
curl -X GET \
  'https://platform.securityscorecard.io/companies/<scorecard_identifier>/issues/service_end_of_life' \
