...
- **Method:** `GET`
- **Path:** `/companies/{scorecard_identifier}/issues/csp_unsafe_policy_v2`
- **Category:** `company-issues`
- **Operation ID:** `get_companies-scorecard-identifier-issues-csp-unsafe-policy-v2`
...
```json
{
  ...
  "properties": {
    "entries": {
      ...
      "items": {
        ...
        "description": "\"csp_unsafe_policy_v2\" issues in a scorecard"
      }
    }
  },
  "additionalProperties": false,
  ...
  "description": "A page in a list of CspUnsafePolicyV2s"
}
```
...
```bash
curl -X GET \
  'https://platform.securityscorecard.io/companies/<scorecard_identifier>/issues/csp_unsafe_policy_v2' \
