...
- **Method:** `GET`
- **Path:** `/companies/{scorecard_identifier}/issues/iot_camera`
- **Category:** `company-issues`
- **Operation ID:** `get_companies-scorecard-identifier-issues-iot-camera`
...
```json
{
  ...
  "properties": {
    "entries": {
      ...
      "items": {
        ...
        "description": "\"iot_camera\" issues in a scorecard"
      }
    }
  },
  "additionalProperties": false,
  ...
  "description": "A page in a list of IotCameras"
}
```
...
```bash
curl -X GET \
  'https://platform.securityscorecard.io/companies/<scorecard_identifier>/issues/iot_camera' \
