...
- **Method:** `GET`
- **Path:** `/companies/{scorecard_identifier}/issues/tlscert_weak_signature`
- **Category:** `company-issues`
- **Operation ID:** `get_companies-scorecard-identifier-issues-tlscert-weak-signature`
...
```json
{
  ...
  "properties": {
    "entries": {
      ...
      "items": {
        ...
        "description": "\"tlscert_weak_signature\" issues in a scorecard"
      }
    }
  },
  "additionalProperties": false,
  ...
  "description": "A page in a list of TlscertWeakSignatures"
}
```
...
```bash
curl -X GET \
  'https://platform.securityscorecard.io/companies/<scorecard_identifier>/issues/tlscert_weak_signature' \
