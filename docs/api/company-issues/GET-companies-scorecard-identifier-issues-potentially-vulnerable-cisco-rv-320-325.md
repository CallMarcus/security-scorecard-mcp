# Get "potentially_vulnerable_cisco_rv_320_325" issu

- **Method:** `GET`
- **Path:** `/companies/{scorecard_identifier}/issues/potentially_vulnerable_cisco_rv_320_325`
- **Category:** `company-issues`
- **Operation ID:** `get_companies-scorecard-identifier-issues-potentially-vulnerable-cisco-rv-320-325`
...
```json
{
  ...
  "properties": {
    "entries": {
      ...
      "items": {
        ...
        "description": "\"potentially_vulnerable_cisco_rv_320_325\" issues in a scorecard"
      }
    }
  },
  "additionalProperties": false,
  ...
  "description": "A page in a list of PotentiallyVulnerableCiscoRv320325s"
}
```
...
```bash
curl -X GET \
  'https://platform.securityscorecard.io/companies/<scorecard_identifier>/issues/potentially_vulnerable_cisco_rv_320_325' \
