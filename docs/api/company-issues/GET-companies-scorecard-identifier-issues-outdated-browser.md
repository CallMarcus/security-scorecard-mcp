...
- **Method:** `GET`
- **Path:** `/companies/{scorecard_identifier}/issues/outdated_browser`
- **Category:** `company-issues`
- **Operation ID:** `get_companies-scorecard-identifier-issues-outdated-browser`
...
```json
{
  ...
  "properties": {
    "entries": {
      ...
      "items": {
        ...
        "description": "\"outdated_browser\" issues in a scorecard"
      }
    }
  },
  "additionalProperties": false,
  ...
  "description": "A page in a list of OutdatedBrowsers"
}
```
...
```bash
curl -X GET \
  'https://platform.securityscorecard.io/companies/<scorecard_identifier>/issues/outdated_browser' \
