# Get "synth_possible_initial_access" historical iss

- **Method:** `GET`
- **Path:** `/companies/{scorecard_identifier}/history/events/{effective_date}/issues/synth_possible_initial_access/`
- **Category:** `company-issues`
- **Operation ID:** `get_companies-scorecard-identifier-history-events-effective-date-issues-synth-possible-initial-access`

## Description

Get "synth_possible_initial_access" historical issues in a scorecard
...
### 200
A page in a list of HistoricalSynthPossibleInitialAccesses
```json
{
  "type": "object",
  "properties": {
    "entries": {
      ...
      "items": {
        ...
        "additionalProperties": false,
        "description": "\"synth_possible_initial_access\" historical issues in a scorecard"
      }
    }
  },
  "additionalProperties": false,
  ...
  "description": "A page in a list of HistoricalSynthPossibleInitialAccesses"
}
```
...
```bash
curl -X GET \
  'https://platform.securityscorecard.io/companies/<scorecard_identifier>/history/events/<effective_date>/issues/synth_possible_initial_access/' \
