# Get "known_compromised_or_hostile_host" issues in 

- **Method:** `GET`
- **Path:** `/companies/{scorecard_identifier}/issues/known_compromised_or_hostile_host`
- **Category:** `company-issues`
- **Operation ID:** `get_companies-scorecard-identifier-issues-known-compromised-or-hostile-host`
...
```json
{
  ...
  "properties": {
    "entries": {
      ...
      "items": {
        ...
        "description": "\"known_compromised_or_hostile_host\" issues in a scorecard"
      }
    }
  },
  "additionalProperties": false,
  ...
  "description": "A page in a list of KnownCompromisedOrHostileHosts"
}
```
...
```bash
curl -X GET \
  'https://platform.securityscorecard.io/companies/<scorecard_identifier>/issues/known_compromised_or_hostile_host' \
