...
- **Method:** `GET`
- **Path:** `/companies/{scorecard_identifier}/issues/typosquat`
- **Category:** `company-issues`
- **Operation ID:** `get_companies-scorecard-identifier-issues-typosquat`
...
### 200
A page in a list of Typosquats
```json
{
  "type": "object",
  "properties": {
    "entries": {
      ...
      "items": {
        ...
        "description": "\"typosquat\" issues in a scorecard"
      }
    }
  },
  "additionalProperties": false,
  ...
  "description": "A page in a list of Typosquats"
}
```
...
```bash
curl -X GET \
  'https://platform.securityscorecard.io/companies/<scorecard_identifier>/issues/typosquat' \
