# Get "x_frame_options_incorrect_v2" issues in a sco

- **Method:** `GET`
- **Path:** `/companies/{scorecard_identifier}/issues/x_frame_options_incorrect_v2`
- **Category:** `company-issues`
- **Operation ID:** `get_companies-scorecard-identifier-issues-x-frame-options-incorrect-v2`
...
```json
{
  ...
  "properties": {
    "entries": {
      ...
      "items": {
        ...
        "description": "\"x_frame_options_incorrect_v2\" issues in a scorecard"
      }
    }
  },
  "additionalProperties": false,
  ...
  "description": "A page in a list of XFrameOptionsIncorrectV2s"
}
```
...
```bash
curl -X GET \
  'https://platform.securityscorecard.io/companies/<scorecard_identifier>/issues/x_frame_options_incorrect_v2' \
