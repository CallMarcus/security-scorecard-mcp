# Get "malicious_scan_detected" issues in a scorecar

- **Method:** `GET`
- **Path:** `/companies/{scorecard_identifier}/issues/malicious_scan_detected`
- **Category:** `company-issues`
- **Operation ID:** `get_companies-scorecard-identifier-issues-malicious-scan-detected`
...
```json
{
  ...
  "properties": {
    "entries": {
      ...
      "items": {
        ...
        "description": "\"malicious_scan_detected\" issues in a scorecard"
      }
    }
  },
  "additionalProperties": false,
  ...
  "description": "A page in a list of MaliciousScanDetecteds"
}
```
...
```bash
curl -X GET \
  'https://platform.securityscorecard.io/companies/<scorecard_identifier>/issues/malicious_scan_detected' \
