# Get "mail_server_unusual_port" issues in a scoreca

- **Method:** `GET`
- **Path:** `/companies/{scorecard_identifier}/issues/mail_server_unusual_port`
- **Category:** `company-issues`
- **Operation ID:** `get_companies-scorecard-identifier-issues-mail-server-unusual-port`
...
```json
{
  ...
  "properties": {
    "entries": {
      ...
      "items": {
        ...
        "description": "\"mail_server_unusual_port\" issues in a scorecard"
      }
    }
  },
  "additionalProperties": false,
  ...
  "description": "A page in a list of MailServerUnusualPorts"
}
```
...
```bash
curl -X GET \
  'https://platform.securityscorecard.io/companies/<scorecard_identifier>/issues/mail_server_unusual_port' \
