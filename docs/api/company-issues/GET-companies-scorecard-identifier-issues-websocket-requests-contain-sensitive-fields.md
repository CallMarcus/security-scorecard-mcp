...
- **Method:** `GET`
- **Path:** `/companies/{scorecard_identifier}/issues/websocket_requests_contain_sensitive_fields`
- **Category:** `company-issues`
- **Operation ID:** `get_companies-scorecard-identifier-issues-websocket-requests-contain-sensitive-fields`
...
### 200
A page in a list of WebsocketRequestsContainSensitiveFields
```json
{
  "type": "object",
  "properties": {
    "entries": {
      ...
      "items": {
        ...
        "description": "\"websocket_requests_contain_sensitive_fields\" issues in a scorecard"
      }
    }
  },
  "additionalProperties": false,
  ...
  "description": "A page in a list of WebsocketRequestsContainSensitiveFields"
}
```
...
```bash
curl -X GET \
  'https://platform.securityscorecard.io/companies/<scorecard_identifier>/issues/websocket_requests_contain_sensitive_fields' \
