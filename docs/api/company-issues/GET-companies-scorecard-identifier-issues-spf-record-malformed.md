...
- **Method:** `GET`
- **Path:** `/companies/{scorecard_identifier}/issues/spf_record_malformed`
- **Category:** `company-issues`
- **Operation ID:** `get_companies-scorecard-identifier-issues-spf-record-malformed`
...
```json
{
  ...
  "properties": {
    "entries": {
      ...
      "items": {
        ...
        "description": "\"spf_record_malformed\" issues in a scorecard"
      }
    }
  },
  "additionalProperties": false,
  ...
  "description": "A page in a list of SpfRecordMalformeds"
}
```
...
```bash
curl -X GET \
  'https://platform.securityscorecard.io/companies/<scorecard_identifier>/issues/spf_record_malformed' \
