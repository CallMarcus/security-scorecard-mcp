# Get "ransomware_infection_trail" issues in a score

- **Method:** `GET`
- **Path:** `/companies/{scorecard_identifier}/issues/ransomware_infection_trail`
- **Category:** `company-issues`
- **Operation ID:** `get_companies-scorecard-identifier-issues-ransomware-infection-trail`
...
### 200
A page in a list of RansomwareInfectionTrails
```json
{
  "type": "object",
  "properties": {
    "entries": {
      ...
      "items": {
        ...
        "description": "\"ransomware_infection_trail\" issues in a scorecard"
      }
    }
  },
  "additionalProperties": false,
  ...
  "description": "A page in a list of RansomwareInfectionTrails"
}
```
...
```bash
curl -X GET \
  'https://platform.securityscorecard.io/companies/<scorecard_identifier>/issues/ransomware_infection_trail' \
