# Get "websocket_receives_data" issues in a scorecar

- **Method:** `GET`
- **Path:** `/companies/{scorecard_identifier}/issues/websocket_receives_data`
- **Category:** `company-issues`
- **Operation ID:** `get_companies-scorecard-identifier-issues-websocket-receives-data`
...
```json
{
  ...
  "properties": {
    "entries": {
      ...
      "items": {
        ...
        "description": "\"websocket_receives_data\" issues in a scorecard"
      }
    }
  },
  "additionalProperties": false,
  ...
  "description": "A page in a list of WebsocketReceivesData"
}
```
...
```bash
curl -X GET \
  'https://platform.securityscorecard.io/companies/<scorecard_identifier>/issues/websocket_receives_data' \
