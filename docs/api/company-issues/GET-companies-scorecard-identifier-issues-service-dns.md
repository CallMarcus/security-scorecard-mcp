...
- **Operation ID:** `get_companies-scorecard-identifier-issues-service-dns`
...
```bash
curl -X GET \
  'https://platform.securityscorecard.io/companies/<scorecard_identifier>/issues/service_dns' \
