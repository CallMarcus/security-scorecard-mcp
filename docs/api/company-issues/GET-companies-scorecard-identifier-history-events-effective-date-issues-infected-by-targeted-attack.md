# Get "infected_by_targeted_attack" historical issue

- **Method:** `GET`
- **Path:** `/companies/{scorecard_identifier}/history/events/{effective_date}/issues/infected_by_targeted_attack/`
- **Category:** `company-issues`
- **Operation ID:** `get_companies-scorecard-identifier-history-events-effective-date-issues-infected-by-targeted-attack`

## Description

Get "infected_by_targeted_attack" historical issues in a scorecard
...
### 200
A page in a list of HistoricalInfectedByTargetedAttacks
```json
{
  "type": "object",
  "properties": {
    "entries": {
      ...
      "items": {
        ...
        "additionalProperties": false,
        "description": "\"infected_by_targeted_attack\" historical issues in a scorecard"
      }
    }
  },
  "additionalProperties": false,
  ...
  "description": "A page in a list of HistoricalInfectedByTargetedAttacks"
}
```
...
```bash
curl -X GET \
  'https://platform.securityscorecard.io/companies/<scorecard_identifier>/history/events/<effective_date>/issues/infected_by_targeted_attack/' \
