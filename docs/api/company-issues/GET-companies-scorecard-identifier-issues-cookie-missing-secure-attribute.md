# Get "cookie_missing_secure_attribute" issues in a 

- **Method:** `GET`
- **Path:** `/companies/{scorecard_identifier}/issues/cookie_missing_secure_attribute`
- **Category:** `company-issues`
- **Operation ID:** `get_companies-scorecard-identifier-issues-cookie-missing-secure-attribute`
...
### 200
A page in a list of CookieMissingSecureAttributes
```json
{
  "type": "object",
  "properties": {
    "entries": {
      ...
      "items": {
        ...
        "description": "\"cookie_missing_secure_attribute\" issues in a scorecard"
      }
    }
  },
  "additionalProperties": false,
  ...
  "description": "A page in a list of CookieMissingSecureAttributes"
}
```
...
```bash
curl -X GET \
  'https://platform.securityscorecard.io/companies/<scorecard_identifier>/issues/cookie_missing_secure_attribute' \
