# Get "patching_cadence_v3_medium" issues in a score

- **Method:** `GET`
- **Path:** `/companies/{scorecard_identifier}/issues/patching_cadence_v3_medium`
- **Category:** `company-issues`
- **Operation ID:** `get_companies-scorecard-identifier-issues-patching-cadence-v3-medium`
...
```json
{
  ...
  "properties": {
    "entries": {
      ...
      "items": {
        ...
        "description": "\"patching_cadence_v3_medium\" issues in a scorecard"
      }
    }
  },
  "additionalProperties": false,
  ...
  "description": "A page in a list of PatchingCadenceV3Mediums"
}
```
...
```bash
curl -X GET \
  'https://platform.securityscorecard.io/companies/<scorecard_identifier>/issues/patching_cadence_v3_medium' \
