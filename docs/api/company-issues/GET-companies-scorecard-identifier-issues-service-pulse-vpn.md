...
- **Method:** `GET`
- **Path:** `/companies/{scorecard_identifier}/issues/service_pulse_vpn`
- **Category:** `company-issues`
- **Operation ID:** `get_companies-scorecard-identifier-issues-service-pulse-vpn`
...
```json
{
  ...
  "properties": {
    "entries": {
      ...
      "items": {
        ...
        "description": "\"service_pulse_vpn\" issues in a scorecard"
      }
    }
  },
  "additionalProperties": false,
  ...
  "description": "A page in a list of ServicePulseVpns"
}
```
...
```bash
curl -X GET \
  'https://platform.securityscorecard.io/companies/<scorecard_identifier>/issues/service_pulse_vpn' \
