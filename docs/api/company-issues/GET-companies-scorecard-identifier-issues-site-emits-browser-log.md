...
- **Method:** `GET`
- **Path:** `/companies/{scorecard_identifier}/issues/site_emits_browser_log`
- **Category:** `company-issues`
- **Operation ID:** `get_companies-scorecard-identifier-issues-site-emits-browser-log`
...
```json
{
  ...
  "properties": {
    "entries": {
      ...
      "items": {
        ...
        "description": "\"site_emits_browser_log\" issues in a scorecard"
      }
    }
  },
  "additionalProperties": false,
  ...
  "description": "A page in a list of SiteEmitsBrowserLogs"
}
```
...
```bash
curl -X GET \
  'https://platform.securityscorecard.io/companies/<scorecard_identifier>/issues/site_emits_browser_log' \
