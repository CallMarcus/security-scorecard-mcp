...
- **Method:** `GET`
- **Path:** `/companies/{scorecard_identifier}/issues/exposed_cisco_web_ui`
- **Category:** `company-issues`
- **Operation ID:** `get_companies-scorecard-identifier-issues-exposed-cisco-web-ui`
...
```json
{
  ...
  "properties": {
    "entries": {
      ...
      "items": {
        ...
        "description": "\"exposed_cisco_web_ui\" issues in a scorecard"
      }
    }
  },
  "additionalProperties": false,
  ...
  "description": "A page in a list of ExposedCiscoWebUis"
}
```
...
```bash
curl -X GET \
  'https://platform.securityscorecard.io/companies/<scorecard_identifier>/issues/exposed_cisco_web_ui' \
