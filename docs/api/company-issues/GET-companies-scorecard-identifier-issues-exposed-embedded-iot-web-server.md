# Get "exposed_embedded_iot_web_server" issues in a 

- **Method:** `GET`
- **Path:** `/companies/{scorecard_identifier}/issues/exposed_embedded_iot_web_server`
- **Category:** `company-issues`
- **Operation ID:** `get_companies-scorecard-identifier-issues-exposed-embedded-iot-web-server`
...
```json
{
  ...
  "properties": {
    "entries": {
      ...
      "items": {
        ...
        "description": "\"exposed_embedded_iot_web_server\" issues in a scorecard"
      }
    }
  },
  "additionalProperties": false,
  ...
  "description": "A page in a list of ExposedEmbeddedIotWebServers"
}
```
...
```bash
curl -X GET \
  'https://platform.securityscorecard.io/companies/<scorecard_identifier>/issues/exposed_embedded_iot_web_server' \
