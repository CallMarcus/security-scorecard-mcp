# Get "exposed_personal_information_info" issues in 

- **Method:** `GET`
- **Path:** `/companies/{scorecard_identifier}/issues/exposed_personal_information_info`
- **Category:** `company-issues`
- **Operation ID:** `get_companies-scorecard-identifier-issues-exposed-personal-information-info`
...
```json
{
  ...
  "properties": {
    "entries": {
      ...
      "items": {
        ...
        "description": "\"exposed_personal_information_info\" issues in a scorecard"
      }
    }
  },
  "additionalProperties": false,
  ...
  "description": "A page in a list of ExposedPersonalInformationInfos"
}
```
...
```bash
curl -X GET \
  'https://platform.securityscorecard.io/companies/<scorecard_identifier>/issues/exposed_personal_information_info' \
