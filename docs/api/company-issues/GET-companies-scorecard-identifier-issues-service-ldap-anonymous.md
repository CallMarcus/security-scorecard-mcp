...
- **Method:** `GET`
- **Path:** `/companies/{scorecard_identifier}/issues/service_ldap_anonymous`
- **Category:** `company-issues`
- **Operation ID:** `get_companies-scorecard-identifier-issues-service-ldap-anonymous`
...
```json
{
  ...
  "properties": {
    "entries": {
      ...
      "items": {
        ...
        "description": "\"service_ldap_anonymous\" issues in a scorecard"
      }
    }
  },
  "additionalProperties": false,
  ...
  "description": "A page in a list of ServiceLdapAnonymous"
}
```
...
```bash
curl -X GET \
  'https://platform.securityscorecard.io/companies/<scorecard_identifier>/issues/service_ldap_anonymous' \
