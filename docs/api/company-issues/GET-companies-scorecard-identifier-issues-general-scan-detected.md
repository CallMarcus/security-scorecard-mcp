...
- **Operation ID:** `get_companies-scorecard-identifier-issues-general-scan-detected`
...
```bash
curl -X GET \
  'https://platform.securityscorecard.io/companies/<scorecard_identifier>/issues/general_scan_detected' \
