# Get "site_requests_data_over_insecure_channel" iss

- **Method:** `GET`
- **Path:** `/companies/{scorecard_identifier}/issues/site_requests_data_over_insecure_channel`
- **Category:** `company-issues`
- **Operation ID:** `get_companies-scorecard-identifier-issues-site-requests-data-over-insecure-channel`
...
```json
{
  ...
  "properties": {
    "entries": {
      ...
      "items": {
        ...
        "description": "\"site_requests_data_over_insecure_channel\" issues in a scorecard"
      }
    }
  },
  "additionalProperties": false,
  ...
  "description": "A page in a list of SiteRequestsDataOverInsecureChannels"
}
```
...
```bash
curl -X GET \
  'https://platform.securityscorecard.io/companies/<scorecard_identifier>/issues/site_requests_data_over_insecure_channel' \
