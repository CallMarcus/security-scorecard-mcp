...
- **Method:** `GET`
- **Path:** `/companies/{scorecard_identifier}/issues/pva_installation_trail`
- **Category:** `company-issues`
- **Operation ID:** `get_companies-scorecard-identifier-issues-pva-installation-trail`
...
### 200
A page in a list of PvaInstallationTrails
```json
{
  "type": "object",
  "properties": {
    "entries": {
      ...
      "items": {
        ...
        "description": "\"pva_installation_trail\" issues in a scorecard"
      }
    }
  },
  "additionalProperties": false,
  ...
  "description": "A page in a list of PvaInstallationTrails"
}
```
...
```bash
curl -X GET \
  'https://platform.securityscorecard.io/companies/<scorecard_identifier>/issues/pva_installation_trail' \
