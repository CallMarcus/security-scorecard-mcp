# Get "threat_actor_hosting_infrastructure" issues i

- **Method:** `GET`
- **Path:** `/companies/{scorecard_identifier}/issues/threat_actor_hosting_infrastructure`
- **Category:** `company-issues`
- **Operation ID:** `get_companies-scorecard-identifier-issues-threat-actor-hosting-infrastructure`
...
```json
{
  ...
  "properties": {
    "entries": {
      ...
      "items": {
        ...
        "description": "\"threat_actor_hosting_infrastructure\" issues in a scorecard"
      }
    }
  },
  "additionalProperties": false,
  ...
  "description": "A page in a list of ThreatActorHostingInfrastructures"
}
```
...
```bash
curl -X GET \
  'https://platform.securityscorecard.io/companies/<scorecard_identifier>/issues/threat_actor_hosting_infrastructure' \
