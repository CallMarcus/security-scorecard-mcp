...
- **Method:** `GET`
- **Path:** `/companies/{scorecard_identifier}/issues/service_couchdb`
- **Category:** `company-issues`
- **Operation ID:** `get_companies-scorecard-identifier-issues-service-couchdb`
...
```json
{
  ...
  "properties": {
    "entries": {
      ...
      "items": {
        ...
        "description": "\"service_couchdb\" issues in a scorecard"
      }
    }
  },
  "additionalProperties": false,
  ...
  "description": "A page in a list of ServiceCouchdbs"
}
```
...
```bash
curl -X GET \
  'https://platform.securityscorecard.io/companies/<scorecard_identifier>/issues/service_couchdb' \
