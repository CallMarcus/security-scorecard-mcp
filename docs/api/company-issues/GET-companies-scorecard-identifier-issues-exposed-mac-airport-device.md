# Get "exposed_mac_airport_device" issues in a score

- **Method:** `GET`
- **Path:** `/companies/{scorecard_identifier}/issues/exposed_mac_airport_device`
- **Category:** `company-issues`
- **Operation ID:** `get_companies-scorecard-identifier-issues-exposed-mac-airport-device`
...
```json
{
  ...
  "properties": {
    "entries": {
      ...
      "items": {
        ...
        "description": "\"exposed_mac_airport_device\" issues in a scorecard"
      }
    }
  },
  "additionalProperties": false,
  ...
  "description": "A page in a list of ExposedMacAirportDevices"
}
```
...
```bash
curl -X GET \
  'https://platform.securityscorecard.io/companies/<scorecard_identifier>/issues/exposed_mac_airport_device' \
