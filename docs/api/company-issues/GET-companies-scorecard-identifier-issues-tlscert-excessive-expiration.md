# Get "tlscert_excessive_expiration" issues in a sco

- **Method:** `GET`
- **Path:** `/companies/{scorecard_identifier}/issues/tlscert_excessive_expiration`
- **Category:** `company-issues`
- **Operation ID:** `get_companies-scorecard-identifier-issues-tlscert-excessive-expiration`
...
```json
{
  ...
  "properties": {
    "entries": {
      ...
      "items": {
        ...
        "description": "\"tlscert_excessive_expiration\" issues in a scorecard"
      }
    }
  },
  "additionalProperties": false,
  ...
  "description": "A page in a list of TlscertExcessiveExpirations"
}
```
...
```bash
curl -X GET \
  'https://platform.securityscorecard.io/companies/<scorecard_identifier>/issues/tlscert_excessive_expiration' \
