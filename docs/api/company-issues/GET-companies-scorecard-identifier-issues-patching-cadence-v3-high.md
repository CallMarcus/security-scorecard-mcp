...
- **Operation ID:** `get_companies-scorecard-identifier-issues-patching-cadence-v3-high`
...
```bash
curl -X GET \
  'https://platform.securityscorecard.io/companies/<scorecard_identifier>/issues/patching_cadence_v3_high' \
