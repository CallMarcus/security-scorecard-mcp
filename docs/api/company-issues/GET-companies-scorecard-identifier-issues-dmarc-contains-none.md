# Get "dmarc_contains_none" issues in a scorecard

- **Method:** `GET`
- **Path:** `/companies/{scorecard_identifier}/issues/dmarc_contains_none`
- **Category:** `company-issues`
- **Operation ID:** `get_companies-scorecard-identifier-issues-dmarc-contains-none`
...
```json
{
  ...
  "properties": {
    "entries": {
      ...
      "items": {
        ...
        "description": "\"dmarc_contains_none\" issues in a scorecard"
      }
    }
  },
  "additionalProperties": false,
  ...
  "description": "A page in a list of DmarcContainsNones"
}
```
...
```bash
curl -X GET \
  'https://platform.securityscorecard.io/companies/<scorecard_identifier>/issues/dmarc_contains_none' \
