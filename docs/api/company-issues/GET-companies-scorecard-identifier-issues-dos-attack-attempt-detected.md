# Get "dos_attack_attempt_detected" issues in a scor

- **Method:** `GET`
- **Path:** `/companies/{scorecard_identifier}/issues/dos_attack_attempt_detected`
- **Category:** `company-issues`
- **Operation ID:** `get_companies-scorecard-identifier-issues-dos-attack-attempt-detected`
...
```json
{
  ...
  "properties": {
    "entries": {
      ...
      "items": {
        ...
        "description": "\"dos_attack_attempt_detected\" issues in a scorecard"
      }
    }
  },
  "additionalProperties": false,
  ...
  "description": "A page in a list of DosAttackAttemptDetecteds"
}
```
...
```bash
curl -X GET \
  'https://platform.securityscorecard.io/companies/<scorecard_identifier>/issues/dos_attack_attempt_detected' \
