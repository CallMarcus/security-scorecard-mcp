# Get "attempted_information_leak" issues in a score

- **Method:** `GET`
- **Path:** `/companies/{scorecard_identifier}/issues/attempted_information_leak`
- **Category:** `company-issues`
- **Operation ID:** `get_companies-scorecard-identifier-issues-attempted-information-leak`
...
```json
{
  ...
  "properties": {
    "entries": {
      ...
      "items": {
        ...
        "description": "\"attempted_information_leak\" issues in a scorecard"
      }
    }
  },
  "additionalProperties": false,
  ...
  "description": "A page in a list of AttemptedInformationLeaks"
}
```
...
```bash
curl -X GET \
  'https://platform.securityscorecard.io/companies/<scorecard_identifier>/issues/attempted_information_leak' \
