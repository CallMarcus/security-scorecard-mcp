...
- **Method:** `GET`
- **Path:** `/companies/{scorecard_identifier}/issues/service_microsoft_sql`
- **Category:** `company-issues`
- **Operation ID:** `get_companies-scorecard-identifier-issues-service-microsoft-sql`
...
```json
{
  ...
  "properties": {
    "entries": {
      ...
      "items": {
        ...
        "description": "\"service_microsoft_sql\" issues in a scorecard"
      }
    }
  },
  "additionalProperties": false,
  ...
  "description": "A page in a list of ServiceMicrosoftSqls"
}
```
...
```bash
curl -X GET \
  'https://platform.securityscorecard.io/companies/<scorecard_identifier>/issues/service_microsoft_sql' \
