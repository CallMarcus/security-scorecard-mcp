...
- **Operation ID:** `get_companies-scorecard-identifier-issues-historical-compromised-credentials-found`
...
```bash
curl -X GET \
  'https://platform.securityscorecard.io/companies/<scorecard_identifier>/issues/historical_compromised_credentials_found' \
