# Gets the list of remediation plans for a vendor

- **Method:** `GET`
- **Path:** `/max/v1/vendor/remediation-plans`
- **Tag:** `V1`
- **operationId:** `getV1VendorRemediationPlans`
...
```bash
curl -X GET \
  'https://api.securityscorecard.io//max/v1/vendor/remediation-plans' \
