...
- **Method:** `PUT`
- **Path:** `/max/v1/indicators/exclusion/{id}`
- **Tag:** `V1`
- **operationId:** `putV1IndicatorsExclusionById`

## Path Parameters
- `id` (**required**) — Primary identifier of exclusion to update.
...
## Responses
### 200
Indicator Exclusion update correctly.
```json
{
  "type": "object",
  "properties": {
...
```
### 404
Indicator Exclusion not found.

## Example cURL Request
```bash
curl -X PUT \
  'https://api.securityscorecard.io//max/v1/indicators/exclusion/<id>' \
