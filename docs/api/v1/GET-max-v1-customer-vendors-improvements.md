...
- **Method:** `GET`
- **Path:** `/max/v1/customer/vendors-improvements`
- **Tag:** `V1`
- **operationId:** `getV1CustomerVendorsImprovements`
...
```bash
curl -X GET \
  'https://api.securityscorecard.io//max/v1/customer/vendors-improvements' \
