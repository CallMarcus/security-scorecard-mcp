...
- **Method:** `GET`
- **Path:** `/max/v1/partner/likelihood-assessments/{id}`
- **Tag:** `V1`
- **operationId:** `getV1PartnerLikelihoodAssessmentsById`
...
```bash
curl -X GET \
  'https://api.securityscorecard.io//max/v1/partner/likelihood-assessments/<id>' \
