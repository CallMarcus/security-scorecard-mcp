...
- **Method:** `GET`
- **Path:** `/max/v1/partner/{customer_id}/raw-findings/daily-avg`
- **Tag:** `V1`
- **operationId:** `getV1PartnerByCustomeridRawFindingsDailyAvg`
...
```bash
curl -X GET \
  'https://api.securityscorecard.io//max/v1/partner/<customer_id>/raw-findings/daily-avg' \
