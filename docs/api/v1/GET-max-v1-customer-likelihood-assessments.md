# Gets the list of likelihood assessments reports of the customer

- **Method:** `GET`
- **Path:** `/max/v1/customer/likelihood-assessments`
- **Tag:** `V1`
- **operationId:** `getV1CustomerLikelihoodAssessments`
...
```bash
curl -X GET \
  'https://api.securityscorecard.io//max/v1/customer/likelihood-assessments' \
