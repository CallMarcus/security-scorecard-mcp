# Gets the breaches for the report

- **Method:** `GET`
- **Path:** `/max/v1/breaches/report/{report_id}`
- **Tag:** `V1`
- **operationId:** `getV1BreachesReportById`
...
## Responses
### 200
Gets the data from the archived reports
```json
{
  "type": "object",
  "properties": {
...
```bash
curl -X GET \
  'https://api.securityscorecard.io//max/v1/breaches/report/{report_id}' \
