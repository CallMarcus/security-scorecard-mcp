# Gets the latest likelihood report for a managed vendor

- **Method:** `GET`
- **Path:** `/max/v1/vendor/likelihood-assessments/latest`
- **Tag:** `V1`
- **operationId:** `getV1VendorLikelihoodAssessmentsLatest`
...
## Responses
### 200
The latest likelihood report for a managed vendor
```json
{
  "type": "object",
  "properties": {
...
```bash
curl -X GET \
  'https://api.securityscorecard.io//max/v1/vendor/likelihood-assessments/latest' \
