# Gets executive summary for the managed customer

- **Method:** `GET`
- **Path:** `/max/v1/partner/customers/{customer_id}/executive-summary`
- **Tag:** `V1`
- **operationId:** `getV1PartnerCustomersByCustomeridExecutiveSummary`
...
## Responses
### 200
Executive summary for the managed customer
```json
{
  "type": "object",
  "properties": {
