...
- **Method:** `GET`
- **Path:** `/max/v1/customer/raw-findings/daily-count`
- **Tag:** `V1`
- **operationId:** `getV1CustomerRawFindingsDailyCount`
...
```bash
curl -X GET \
  'https://api.securityscorecard.io//max/v1/customer/raw-findings/daily-count' \
