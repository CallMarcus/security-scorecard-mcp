# Gets the list of likelihood assessments for a vendor

- **Method:** `GET`
- **Path:** `/max/v1/vendor/likelihood-assessments`
- **Tag:** `V1`
- **operationId:** `getV1VendorLikelihoodAssessments`
...
## Responses
### 200
A list of likelihood assessment data
```json
{
  "type": "object",
  "properties": {
...
```bash
curl -X GET \
  'https://api.securityscorecard.io//max/v1/vendor/likelihood-assessments' \
