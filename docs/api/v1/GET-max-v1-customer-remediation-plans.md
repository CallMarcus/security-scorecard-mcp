# Gets the list of remediation plans for a customer

- **Method:** `GET`
- **Path:** `/max/v1/customer/remediation-plans`
- **Tag:** `V1`
- **operationId:** `getV1CustomerRemediationPlans`
...
- `vendor_domain` (optional, string) — Vendor domainscomma separated
...
```bash
curl -X GET \
  'https://api.securityscorecard.io//max/v1/customer/remediation-plans' \
