...
- **Method:** `GET`
- **Path:** `/max/v1/customer/incident-likelihood-over-time`
- **Tag:** `V1`
- **operationId:** `getV1CustomerIncidentLikelihoodOverTime`
...
```bash
curl -X GET \
  'https://api.securityscorecard.io//max/v1/customer/incident-likelihood-over-time' \
