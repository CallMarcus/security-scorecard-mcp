...
- **Operation ID:** `getPlansManagedServices`

## Query Parameters

- `page` (number, Optional) - page number, 0 is the first page
- `limit` (number, Optional) - page size, the amount of items per page (max: 200)
- `sort` (string, Optional) - plans list sorted field
- `search` (string, Optional) - search text to look into plans fields
