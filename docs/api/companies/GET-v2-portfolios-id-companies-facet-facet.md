...
- **Method:** `GET`
- **Path:** `/v2/portfolios/{id}/companies/facet/{facet}`
- **Category:** `companies`
- **Operation ID:** `get_v2-portfolios-id-companies-facet-facet`
...
```bash
curl -X GET \
  'https://platform.securityscorecard.io/v2/portfolios/<id>/companies/facet/<facet>' \
